    ...
    if(!$helper->isUserLogged()) {
        ...
        if($allowed){
            if(isset($_GET['id'])) {
                ...
                $result = $leave->singleReadFullQry("SELECT s.id, s.requestNo, l.name as leave_type, s.dateFiled, s.startDate, s.endDate, s.total, s.modified, s.currentStatus, s.reason, s.attachment FROM standardleave as s LEFT OUTER JOIN leavetype as l ON s.leavetype_id = l.id WHERE s.id = $id AND s.staff_id = '$staffId'");
                        ...
                        <div class="container-fluid">
                            <div class="row page-titles">
                                <div class="col-md-5 col-xs-18 align-self-center">
                                    <h3 class="text-themecolor m-b-0 m-t-0">My Approvals Leave Request Details</h3>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item">Home</a></li>
                                        <li class="breadcrumb-item">Standard Leave</li>
                                        <li class="breadcrumb-item">My Approvals Leave Request List</li>
                                        <li class="breadcrumb-item">My Approvals Leave Request Details</li>
                                    </ol>
                                </div>
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <div class="form-horizontal p-t-5" action="" method="POST" novalidate enctype="multipart/form-data">
                                                                        <div class="form-group row">
                                                                            <label  class="col-sm-3 control-label">Current Status <br>    حالة الطلب     </label>
                                                                            <div class="col-sm-9">
                                                                                <div class="controls">
                                                                        ...
                                                                        <div class="form-group row">
                                                                            <label  class="col-sm-3 control-label"><span class="text-danger">*</span>Kind of Leave <br>    نوع الاجازه     </label>
                                                                            <div class="col-sm-9">
                                                                                <div class="controls">
                                                                                    <div class="input-group">
                                                                        ...
                                                                        <div class="form-group row">
                                                                            <label  class="col-sm-3 control-label"><span class="text-danger">*</span>Leave Date <br>    تاريخ الاجازة  </label>
                                                                            <div class="col-sm-9">
                                                                        ...
                                                                        <div class="form-group row stateYourReason" style="display: none">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    ...
                                                                    <?php
                                                                        $i = 0;
                                                                        $rows = $helper->readData("SELECT * FROM standardleave_history WHERE standardleave_id = $id");
