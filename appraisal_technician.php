...
?>
        ...
        <body class="fix-header fix-sidebar card-no-border">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-header bg-light-success" style="border-bottom: double; border-color: #28a745">
                                        <div class="d-flex no-block align-items-center">
                                            <h4 class="card-title font-weight-bold">Staff Appraisal Form - Technician [<?php echo $appraisalYear; ?>]</h4>
                                            <div class="ml-auto">
                                                <ul class="list-inline text-right">
                                                    ...
                                                    $rec = $checkSubmitted->singleReadFullQry("SELECT TOP 1 * FROM appraisal_technician WHERE staff_id = '$staffId' AND appraisal_year = '$currentYear' ORDER BY id DESC");
                                                    ...
                                                    <li>
                                                        <!-- <a style="<?php echo $show; ?>" href="appraisal_technician_view.php?id=<?php echo $rec['id']; ?>&y=<?php echo $_GET['y']; ?>" target="_blank" class="btn btn-sm btn-warning waves-effect waves-light" title="Click to Show the Appraisal Result to Staff"><i class="fas fa-search"></i> View Result</a> -->
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="tab-content">
                                                        ...
                                                        <div class="table-responsiveXXX">
                                                            <table class="display nowrap table table-hover table-striped table-bordered">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    $rows = $qua->readData("SELECT sq.*, d.name as degree, c.name as certification FROM staffqualification as sq INNER JOIN degree as d ON d.id = sq.degree_id INNER JOIN certificate as c ON c.id = sq.certificate_id WHERE staffId = '$staffId'");
                                                                    if ($qua->totalCount != 0) {
                                                                        $i = 0;
                                                                        foreach ($rows as $row) {
                                                                    ?>
                                            ...
                                            <div class="tab-pane p-20" id="SelfAppraisal" role="tabpanel">
                                                <?php
                                                if (isset($_POST['submitTechnician'])) {
                                                    $submit = new DbaseManipulation;
                                                    $row = $submit->singleReadFullQry("SELECT TOP 1 a.*, sp.title FROM appraisal_approval_sequence as a INNER JOIN staff_position as sp ON sp.id = a.approver_id WHERE a.active = 1 AND a.position_id = $myPositionId ORDER BY a.sequence_no");
                                                    $sequence_no = $row['sequence_no'];
                                                    $approver_id = $row['approver_id'];
                                                    $checkRequest = new DbaseManipulation;
                                                    $requestIdNumber = $_POST['request_no'];
                                                    $checkRequest->singleReadFullQry("SELECT TOP 1 id, requestNo FROM appraisal_technician WHERE requestNo = '$requestIdNumber' ORDER BY id DESC");
                                                    if ($checkRequest->totalCount != 0) {
                                                        $req = new DbaseManipulation;
                                                        $newReqNo = $req->requestNo("TAP-", "appraisal_technician");
                                                    } else {
                                                    ...
                                                    $fields = [
                                                        ...
                                                        'gs3' => $_POST['techtextarea_goal3'],
                                                        'gs4' => $_POST['techtextarea_goal4']
                                                    ];
                                                    $saveTech = new DBaseManipulation;
                                                    if ($saveTech->insert("appraisal_technician", $fields)) {
                                                        ...
                                                        if ($emailParticipants->smtpMailer($to, $from_name, $from, $subject, $message)) {
                                                            ...
                                                            $emailFields = [
                                                                'requestNo' => $newReqNo,
                                                                'moduleName' => 'Technician - Staff Appraisal Submitted',
                                                                'sentStatus' => 'Sent',
                                                ...
                                                if ($checkSubmitted->totalCount != 0) {
                                                    ...
                                                    <form novalidate>
                                                        <div class="card">
                                                            <div class="card-header bg-light-success p-b-0 p-t-5">
                                                                <h4 class="card-title">Job Definition</h4>
                                                            </div>
                                                            <div class="card-body">
                                                ...
                                                ?>
                                                    <form id="techForm" method="POST" action="" novalidate>
                                                        <div class="card">
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="form-group">
                                                                    <h5>4. Were there any situations that delayed you in doing your work? If yes, what were the conditions and how did they affect your work? <span class="text-danger">*</span></h5>
                                                                    <div class="controls">
                                                                        <textarea name="techtextarea_job4" class="textarea_job4 form-control" rows="3" required data-validation-required-message="This field is required"></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="card">
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="form-group">
                                                                    <h5>3. In what type of staff developmental activities do you feel you need more training (e.g. computer skills, English, new machines/equipment, Hi Tech equipment, etc)? <span class="text-danger">*</span></h5>
                                                                    <div class="controls">
                                                                        <textarea name="techtextarea_goal3" class="textarea_goal3 form-control" rows="3" required data-validation-required-message="This field is required"></textarea>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <h5>4. List any additional items you would like to discuss. <span class="text-danger">*</span></h5>
                                                                    <div class="controls">
                                                                        <textarea name="techtextarea_goal4" class="textarea_goal4 form-control" rows="3" required data-validation-required-message="This field is required"></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <!--end card body Goal Setting-->
                                                        ...
                                                        <div class="text-xs-right">
                                                            ...
                                                            <button type="submit" name="submitTechnician" class="btn btn-info waves-effect waves-light"><i class="fa fa-paper-plane"></i> Submit Appraisal</button>
                                                                ...
                                                                <div class="table-responsiveXXX">
                                                                    <div class="row border-bottom ">
                                                                        <div class="card-header bg-light-success ">
                                                                            <h4 class="card-title"> General Attribute <i><?php echo $tobeVisible3 ?></i></h4>
                                                                        </div>
                                                                        ...
                                                                        $rows = $sdn->singleReadFullQry("SELECT * FROM [appraisal_technician_general_attribute] WHERE appraisal_technician_id =  $appraisal_technician_id"); //1 is fixed for technicians
                                                                        ?>
                                                                        ...
                                                                        <div class="col-lg-4">
                                                                            <label>
                                                                                <h3><span id="totalScore"><?php echo $rows['total'] ?></span> - <span id="totalRemarks"><?php echo $rows['remarks']; ?></span></h3>
                                                                            </label>
                                                                        </div>
                                                                    ...
                                                                    <div class="row border-bottom m-t-5">
                                                                        ...
                                                                        ?>
                                                                        <div class="card-header bg-light-success p-b-0 p-t-5">
                                                                            <h4 class="card-title">Observation of Official <i><?php echo $tobeVisible3 ?></i></h4>
                                                                        </div>
                                                                        <div class="card-body">
            ...
            <script>
                $(document).ready(function() {
                    $('.textarea_job1').wysihtml5({
                        "image": false,
                        "link": false,
                        "font-styles": false,
                        "emphasis": false
                    });
                    $('.textarea_job2').wysihtml5({
                        "image": false,
                        "link": false,
                        "font-styles": false,
                        "emphasis": false
                    });
                    $('.textarea_job3').wysihtml5({
                        "image": false,
                        "link": false,
                        "font-styles": false,
                        "emphasis": false
                    });
                    $('.textarea_accomplishment1').wysihtml5({
                        "image": false,
                        "link": false,
                        "font-styles": false,
                        "emphasis": false
                    });
                    $('.textarea_accomplishment2').wysihtml5({
                        "image": false,
                        "link": false,
                        "font-styles": false,
                        "emphasis": false
                    });
                    $('.textarea_accomplishment3').wysihtml5({
                        "image": false,
                        "link": false,
                        "font-styles": false,
                        "emphasis": false
                    });
                    $('.textarea_accomplishment4').wysihtml5({
                        "image": false,
                        "link": false,
                        "font-styles": false,
                        "emphasis": false
                    });
                    $('.textarea_goal1').wysihtml5({
                        "image": false,
                        "link": false,
                        "font-styles": false,
                        "emphasis": false
                    });
                    $('.textarea_goal2').wysihtml5({
                        "image": false,
                        "link": false,
                        "font-styles": false,
                        "emphasis": false
