                        ...
                        <div class="container-fluid">
                            <div class="row page-titles">
                                <div class="col-md-5 col-xs-18 align-self-center">
                                    <h3 class="text-themecolor m-b-0 m-t-0">Staff Internal Leave Balance History</h3>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item">Home</a></li>
                                        <li class="breadcrumb-item">Internal Balance</a></li>
                                        <li class="breadcrumb-item">Staff Internal Balance History</li>
                                    </ol>
                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="profiletimeline">
                                                        <div class="sl-item">
                                                            <div class="sl-right">
                                                                <div>
                                                                    <span class="text-blue h5">Current Internal Leave Balance : <?php echo $data->getInternalLeaveBalance($info['staffId'],'balance'); ?></span>
                                                                    <div class="like-comm">
                                                                        <span class="text-dark"> Pending Minus : <?php echo $data->getInternalLeavePending($info['staffId'],'balance'); ?></span>
                                                                    </div>
                                                                    <div class="like-comm">
                                            ...
                                            <div class="table-responsive">
                                                <table id="intLeaveBalanceHistory" class="display table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                            $i = 0; 
                                                            $rows = $data->readData("SELECT i.*, l.name as leavetype FROM internalleavebalancedetails as i LEFT OUTER JOIN leavetype as l ON l.id = i.leavetype_id WHERE i.staffId = '$id' ORDER BY i.id");
                                                            $runningBalance = 0;
                                                            foreach ($rows as $row) {
                                                                $staffId = $row['staffId'];
                                                                if ($row['addType'] == 1) 
                                                        ...
                                                        ?>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <?php
                                                                            if(strpos($row['internalleavebalance_id'], 'STL-') !== false) {
                                                                        ?>
                                                                                <a href="standardleave_details.php?id=<?php echo $row['internalleavebalance_id']; ?>&uid=<?php echo $staffId; ?>"><?php echo $row['internalleavebalance_id']; ?></a>
                                                                        <?php
                                                                            } else {
                                                                                echo $row['internalleavebalance_id'];
                                                                            }
                                                                        ?>        
                                                                    </td>
                                                                    <td>
                                                                        <?php
                                                                            if($row['leavetype_id'] == 0) {
                                                                                echo "Balance Added"; 
                                                                            } else {
                                                                                echo $row['leavetype']; 
                                                                            }    
                                                                    ...
                                                                    <td><?php echo $row['status']." <small class='text-primary'>[".$row['notes']."]</small>"; ?></td>
                                                                    ...
                                                                    ?>
                                                                    <td>
                                                                        <a delete-id="<?php echo $row['id']; ?>" class="btn btn-sm btn-danger text-white btnDelete"><i class="fa fa-trash"></i> Delete</a>
                                                                    </td>
                                                                </tr>
                                                        <?php
                                                            }
                        ...
                        bootbox.confirm({
                            ...
                            callback: function (result) {
                                if(result==true){
                                    ...
                                    $.ajax({
                                        url  : 'ajaxpages/leaves/add-internal/addedleave_delete.php',
                                        type    : 'POST',
                                        dataType: 'json',
                                        data    : data,
                                        success : function(e){
                                            if(e.errors == 0) {
                                                bootbox.hideAll();
                                                bootbox.alert("<h4><i class='fa fa-info-circle'></i> Leave has been deleted!</h4>", function(){ location.reload(); })
                                            } else {
                                                bootbox.hideAll();
                                                bootbox.alert("<h4><i class='fa fa-exclamation-triangle'></i> Error deleting leave!</h4>", function(){ location.reload(); })
                                            }
                                        }, error  : function(e){}
                                    });
                                }
