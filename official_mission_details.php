    ...
    if(!$helper->isUserLogged()) {
        ...
        if($allowed){
            if(isset($_GET['id'])) {
                ...
                //echo "SELECT s.id, s.requestNo, l.name as leave_type, s.dateFiled, s.startDate, s.endDate, s.total, s.modified, s.currentStatus, s.reason, s.attachment FROM standardleave as s LEFT OUTER JOIN leavetype as l ON l.id = s.leavetype_id WHERE s.requestNo = '$id' AND s.staff_id = '$uid'";
                //exit;
                        ...
                        <div class="container-fluid">
                            <div class="row page-titles">
                                <div class="col-md-5 col-xs-18 align-self-center">
                                    <h3 class="text-themecolor m-b-0 m-t-0">Official Duty Details</h3>
                                    <ol class="breadcrumb">
                                                    ...
                                                    <div class="row">
                                                            ...
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    <div class="d-flex flex-wrap">
                                                                        <div>
                                                                            <h3 class="card-title">Official Duty Details</h3>
                                                                            <h6 class="card-subtitle">تفاصيل مهمة العمل</h6>
                                                                        </div>
                                                                        <div class="ml-auto">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    <div class="d-flex flex-wrap">
                                                                        <div>
                                                                            ...
                                                                            <h6 class="card-subtitle">تسلسل إعتماد مهام العمل</h6>
                                                                        </div>
                                                                    </div>
                                                                    <?php
                                                                        $i = 0;
                                                                ...
                                                                <div class="card-body">
                                                                        <a href="pdf_single_official_mission.php?staffId=<?php echo $uid; ?>&requestNo=<?php echo $id; ?>" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Print (All Approval)</a>
                                                                        <a href="pdf_single_official_mission2.php?staffId=<?php echo $uid; ?>&requestNo=<?php echo $id; ?>" target="_blank" class="btn btn-info"><i class="fa fa-print"></i> Print (First and Last Approval)</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
