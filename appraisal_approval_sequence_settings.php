                            ...
                            <div class="row page-titles">
                                <div class="col-md-5 col-8 align-self-center">
                                    ...
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item">Update List</li>
                                    </ol>
                                </div>
                                    ...
                                    <div class="card">
                                        <div class="card-header bg-light-info">
                                            <div class="d-flex flex-wrap">
                                                <div>
                                                    <h3 class="card-title">Appraisal Approval Sequence Form for Position <p class="font-weight-bold text-primary">[<?php echo $staff_position; ?>]</p></h3>
                                        ...
                                        <div class="card-body">
                                            <?php
                                                if(isset($_POST['submitApprovalSequence'])){
                                                    ...
                                                    //$last = $info->singleReadFullQry("SELECT TOP 1 sequence_no FROM appraisal_approval_sequence WHERE department_id = $department_id AND position_id = $position_id ORDER BY sequence_no DESC");
                                                ...
                                                if(isset($_POST['updateApprovalSequence'])) {
                                                    ...
                                                    if($save->update("appraisal_approval_sequence",$fields,$id)) {
                                                        ...
                                                        if($save->insert("approvalsequence_standard_history",$fieldsHistory)) {
                                                            ...
                                                            $rows = $helper->readData("SELECT * FROM appraisal_approval_sequence WHERE position_id = $position_id AND active = 1 ORDER BY sequence_no");
                                                            if($helper->totalCount != 0) {
                                                                $i = 1;
                                                                foreach($rows as $row){
                                                                    $id = $row['id'];
                                                                    $seqUpdater->executeSQL("UPDATE appraisal_approval_sequence SET sequence_no = $i WHERE id = $id");
                                                                    $i++;
                                                                }
                                                            }
                                                            ?>
                                                                <div class="alert alert-success alert-dismissible fade show" role="alert">
                                                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                                    <h4 class="alert-heading"><i class="fa fa-info-circle"></i> Success!</h4>
                                                                    <p>Appraisal approval sequence has been edited and updated.</p>
                                                                </div>
                                                            <?php
                                                        }
                                                    }
                                            ...
                                            <form class="form-horizontal p-t-20 p-l-0 p-" action="" method="POST" novalidate enctype="multipart/form-data">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <div class="controls">
                                                            <div class="input-group">
                                                                ...
                                                                <select name="approver_id" class="form-control select2 position_id" required data-validation-required-message="Please select college position">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <div class="controls">
                                                            <div class="input-group">
                                                                <select name="sequenceNo" class="form-control" required data-validation-required-message="Please select sequence">
                                                ...
                                                <div class="form-group row m-b-0">
                                                    <div class="offset-sm-3 col-lg-9">
                                                        <!-- <button type="submit" name="submitApprovalSequence" class="btn btn-info waves-effect waves-light submitApprovalSequence"><i class="fa fa-paper-plane"></i> Submit</button> -->
                                ...
                                <div class="col-lg-8 col-sm-18"><!---start for list div-->
                                    <div class="card">
                                        <div class="card-header bg-light-info">
                                            <div class="d-flex flex-wrap">
                                                <div>
                                                    <h4 class="card-title">Appraisal Approver for Position [<span class="font-weight-bold text-primary"><?php echo $staff_position; ?></span>] [<span class="font-weight-bold text-primary"><?php echo $staff_department; ?></span>]</h4>
