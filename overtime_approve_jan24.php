                                                ...
                                                decline: {
                                                    ...
                                                    callback: function(result){
                                                        ...
                                                        if(notes == '') {
                                                            ...
                                                            ajaxLoader("notification_for_approvals_actions.php","id="+id+"&requestNoS="+requestNo+"&approverId="+approverId+"&approverEmail="+approverEmail+"&notes="+notes+"&action=3&approvalType=otl",".OTLApprovedConfirmation");
