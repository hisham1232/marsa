                        ...
                        <div class="container-fluid">
                            <div class="row page-titles">
                                <div class="col-md-5 col-xs-18 align-self-center">
                                    <h3 class="text-themecolor m-b-0 m-t-0">My Approvals Official Mission Request Details</h3>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item">Home</a></li>
                                        <li class="breadcrumb-item">Official Mission</li>
                                        <li class="breadcrumb-item">My Approval List</li>
                                        <li class="breadcrumb-item">My Approvals Official Mission Request Details</li>
                                    </ol>
                                </div>
                                                            ...
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    <div class="d-flex flex-wrap">
                                                                        <div>
                                                                            <h3 class="card-title">Official Mission Application Details</h3>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="form-group row">
                                                                            <label  class="col-sm-3 control-label"><span class="text-danger">*</span>Official Mission Date</label>
                                                                            <div class="col-sm-9">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    <div class="d-flex flex-wrap">
                                                                        <div>
                                                                            <h3 class="card-title">Official Mission Approval Sequence</h3>
                                                                            <h6 class="card-subtitle">Arabic Text Here</h6>
                                                                        </div>
                                                                    </div>
                                                                    <?php
