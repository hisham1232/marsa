...
<table border="1" cellpadding="2" cellspacing="2" align="right" width="555">
 <tr nobr="true" >
	<td border="0" align="center">Leave Information</td>
 </tr>
 <tr nobr="false">
 ...
 <tr nobr="false">
	<td width="130">نوع الإجازة</td>
	<td width="267" align="left">{$leaveTypeDesc} </td>
	<td width="150" align="left">Leave Type </td>
 </tr>
 <tr nobr="false">
	<td width="130">بدء الإجازة</td>
	<td width="267" align="left">{$beginleave} </td>
	<td width="150" align="left">Begin of Leave </td>
 </tr>
 <tr nobr="false">
	<td width="130">العودة من الإجازة</td>
	<td width="267" align="left">{$returnleave} </td>
	<td width="150" align="left">Return From Leave </td>
 </tr>
 <tr nobr="false">
 ...
 <tr nobr="false">
	...
	<td width="150" align="left">Reasons for Leave</td>
 </tr> 
</table>
EOD;
$pdf->writeHTML($tbl, true, false, false, false, '');
...
$rows = $history->readData("SELECT sh.*, concat(s.firstName,' ',s.secondName,' ',s.thirdName,' ',s.lastName) as staffName FROM standardleave_history as sh LEFT OUTER JOIN staff as s ON s.staffId = sh.staff_id WHERE requestNo = '$requestNo' ORDER BY id DESC");
