                                        ...
                                        <div class="card-body">
                                            <div class="d-flex flex-wrap">
                                                <div>
                                                    ...
                                                    <h6 class="card-subtitle">أضف مؤهل</h6> 
                                                </div>
                                            </div>
                                            <?php 
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="controls">
                                                            <div class="input-group">
                                                                <input type="text" name="name" class="form-control" required data-validation-required-message="Please type the qualification name" /> 
                                                            </div><!--end input-group-->
                                                        </div><!--end controls-->
                                                    </div><!--end col-sm-9-->
