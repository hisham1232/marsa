                        ...
                        <div class="container-fluid">
                            <div class="row page-titles">
                                <div class="col-md-5 col-xs-18 align-self-center">
                                    <h3 class="text-themecolor m-b-0 m-t-0">Staff Appraisal Approval Sequence</h3>
                                    <ol class="breadcrumb">
                                    ...
                                    <div class="card">
                                        <div class="card-header bg-light-yellow m-b-0 p-b-0">
                                            <div class="d-flex flex-wrap">
                                                <div>
                                                    <h3 class="card-title">Staff Appraisal Approval Sequence by College Position</h3>
                                                </div>
                                            </div>
                                        </div> 
                                        <div class="card-body">
                                                            ...
                                                            foreach($rows as $row){
                                                                ...
                                                                <div class="card">
                                                                    ...
                                                                    <div id="departmentId<?php echo $row['department_id']; ?>" class="collapse fade" aria-labelledby="headingOne" data-parent="#accordionShortLeaveSequence">
                                                                        <a href="appraisal_approval_sequence_add.php?did=<?php echo $row['department_id']; ?>" class="btn  btn-primary waves-effect waves-light" role="button" title="Click to view/edit Approval Sequence"><span class="text-white"><i class="fa fa-paper-plane"></i> Add New</span></a>
                                                                        <br>
                                                                        <div class="card-body">
                                                                                ...
                                                                                <table data-toggle="table"  data-mobile-responsive="true" class="table">
                                                                                    ...
                                                                                    <tbody>
                                                                                        <?php
                                                                                            ...
                                                                                            $pos = $distinct_position_id->readData("SELECT DISTINCT p.position_id, sp.title FROM appraisal_approval_sequence as p LEFT OUTER JOIN staff_position as sp ON sp.id = p.position_id WHERE p.department_id = $department_id ORDER BY p.position_id");
                                                                                                ...
                                                                                                foreach($pos as $p) {
                                                                                                    ...
                                                                                                    $position_title = $p['title'];
                                                                                                        ...
                                                                                                        echo "<tr>
                                                                                                                ...
                                                                                                                ?>
                                                                                                                    <td><a href="appraisal_approval_sequence_settings.php?pid=<?php echo $posi_id; ?>&did=<?php echo $row['department_id']; ?>" class="btn btn-sm btn-info waves-effect waves-light" role="button" title="Click to view/edit Approval Sequence"><span class="text-white"><i class="fa fa-paper-plane"></i> Update List</span></a></td>
                                                                                                                <?php                                                                                                            
                                                                                                        echo "</tr>";
                                                                                                }        
                                                                                            } else {
