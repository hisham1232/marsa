                                                    ...
                                                    <tbody>
                                                        <?php 
                                                            ...
                                                            if(isset($_POST['submit'])) {
                                                                ...
                                                                if($helper->isAllowed('HoS')) {
                                                                    $filter = ' AND e.section_id = '.$logged_in_section_id;
                                                                } else if ($helper->isAllowed('HoD_HoC')) {
                                                                    if($myPositionId <= 4) {
                                                                        $filter = ' AND g.current_approver_id = '.$myPositionId;
                                                                    } else {
                                                                ...
                                                                $sql = "SELECT g.*, concat(s.firstName,' ',s.secondName,' ',s.thirdName,' ',s.lastName) as responderName, concat(ss.firstName,' ',ss.secondName,' ',ss.thirdName,' ',ss.lastName) as complainantName, d.name as department
                                                                    ...
                                                                    LEFT OUTER JOIN staff as s ON g.responder = s.staffId 
                                                                    LEFT OUTER JOIN staff as ss ON g.complainant = ss.staffId 
                                                                    LEFT OUTER JOIN department as d ON d.id = e.department_id WHERE e.isCurrent = 1".$filter." ORDER BY status DESC, id DESC";
                                                            }
                                                            //echo $sql;
                                                                ...
                                                                foreach ($rows as $row) {
                                                                    ...
                                                                    ?>
                                                                        <tr class="<?php echo $class; ?>">
                                                                            <td><?php echo ++$i.'.'; ?></td>
                                                                            <td><a href="grievance_details.php?id=<?php echo $row['id']; ?>"><?php echo $row['complainantName']; ?></a></td>
