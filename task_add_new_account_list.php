                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="intLeaveBalanceHistory"
                                        class="display table-hover table-striped table-bordered" cellspacing="0"
                                        width="100%">
                                        <thead>
                                            <tr>
                                                <th>##</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="font-weight:bold"><a
                                                        href="task_add_account_details.php?id=<?php echo $row['staff_id']; ?>&t=<?php echo $row['id']; ?>"><?php echo $row['requestNo']; ?></a>
                                                </td>
                                                ...
                                                <td>
                                                    <?php
                                                                                    ...
                                                                                    ?>
                                                    <i class="fa fa-thumbs-up"></i> Completed <p><small
                                                            class="label label-info"><?php echo date('d/m/Y H:i:s', strtotime($transDate)); ?></small>
                                                    </p>
                                                    <?php        
                                                                                        } else {
                                                                                            echo $status;                                                                           
                                    ...
                                    <table id="intLeaveBalanceHistory"
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="clickable-row"
                                                data-href="task_add_account_details.php?id=<?php echo $row['staff_id']; ?>&t=<?php echo $row['id']; ?>">
                                                <td><?php echo ++$i."."; ?></td>
