                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <?php 
                                                                                    ...
                                                                                    foreach ($rows as $row) {
                                                                                        array_push($ResearchArray,$row['status']);
                                                                                    }
                                                                                    if (in_array('Pending', $ResearchArray)) {
                                                                                        echo '<span class="text-warning"><i class="fa fa-hand-paper"></i> Pending</span>';
                                                                                    } else if (in_array('Declined', $ResearchArray)) {
                                                                                        echo 'Declined';
                                                                                    } else {
                                                                                        echo '<span class="text-success"><i class="fa fa-check"></i> Completed</span>';
                                                                                    } 
                                                                            ...
                                                                            <td>
                                                                                <?php 
                                                                                    $rows = $helper->readData("SELECT clearance_process_id, status FROM clearance_approval_status WHERE clearance_process_id IN (11) AND clearance_id = $cid");
                                                                                    foreach ($rows as $row) {
