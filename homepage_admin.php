                                        ...
                                        <div class="card-body">
                                            ...
                                            <ul class="feeds">
                                                <li>
                                                    ...
                                                    <a href="staff_details.php" class="text-dark" title="Click to view Staff Profile"> My Profile</a></li>
                                                <li>
                                                ...
                                                <?php
                                                    if($_SESSION['user_type'] == 0 || $_SESSION['user_type'] == 1) { //0 - Super User, 1 - HR Head, 2 - HR Staff
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex no-block align-items-center">
                                                ...
                                                <div class="ml-auto">
                                                    <ul class="list-inline text-right">
                                                        <li>
                                                            <a href="staff_generate_id.php" title="Click to Add New Staff" class="btn btn-sm bg-light-info waves-effect waves-light text-info" ><i class="far fa-paper-plane"></i> Add New Staff</a>
                                                        </li>
                                                        <li>
                                                            <a href="staff_list_active.php" title="Click to View All Active Staff" class="btn btn-sm bg-light-info waves-effect waves-light text-info" ><i class="far fa-paper-plane"></i> All Active Staff</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <ul class="feeds">
                                                <li>
                                                    <div class="bg-light-danger"><i class="far fa-folder-open"></i></div><a href="standardleave_all_list.php" class="text-dark" title="Click to View All Standard Leave List"> All Standard Leave Request</a>
                                                    <span>
                                                        <a href="standardleave_list_today.php" title="Click to New View Standard Leave Request" class="btn btn-sm waves-effect waves-light text-info">New Standard Leave [3]</a>
                                                    </span>
                                                </li>
                                                <li>
                                                    <div class="bg-light-danger"><i class="far fa-folder-open"></i></div><a href="shortleave_all_list.php" class="text-dark" title="Click to View All Short Leave List"> All Short Leave Request</a>
                                                    <span>
                                                        <a href="shortleave_list_today.php" title="Click to View New Short Leave Request" class="btn btn-sm waves-effect waves-light text-info">New Short Leave [3]</a>
                                                    </span>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <div class="bg-light-info"><i class="fas fa-archive"></i></div><a href="internal_balance_all_balance.php" class="text-dark" title="Click to All Internal Balance"> All Internal Balance</a></li>
                                                <li>
                                                    <div class="bg-light-info"><i class="fas fa-archive"></i></div><a href="internal_balance_all_balance.php" class="text-dark" title="Click to All Emergency Balance"> All Emergency Balance</a></li>
                                            </ul>
                                        </div><!--end card-body-->
                                    </div><!-- end card-->
                                ...
                                <div class="col-lg-6">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="text-center m-t-15">
                                                        <ul class="list-inline">
                                                            <li>
                                                                <h6 style="color: #00897B">Remaining Internal Balance <strong>[<?php echo $intLeaveBal; ?>]</strong></h6>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div><!--end chard body-->
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="text-center">
                                                        <ul class="list-inline">
                                                            ...
                                                            <li>
                                                            <h6 class="text-muted  text-info"><i class="fa fa-circle font-10"></i> <strong>Remaining Balance [<span class="emRemaining"><?php echo abs($emerLeaveBal); ?></span>]</strong></h6>
                                                        </ul>
                                                    </div>
                                                </div><!--end card body-->
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="card">
                                                <div class="card-body">
                                                    <h4 class="card-title">Staff Statistics</h4>
