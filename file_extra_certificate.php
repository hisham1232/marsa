                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="d-flex flex-wrap">
                                                <div>
                                                    <h3 class="card-title">Add New Extra Certificates</h3>
                                                    <h6 class="card-subtitle">اضافة شهادة اضافية</h6> 
                                                </div>
                                            </div>
                                            <?php 
                                ...
                                <div class="col-lg-6"><!---start for list div-->
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="card-title">Extra Certificates Names List</h4>
