                                            ...
                                            <div class="col-md-5">
                                                ...
                                                ?>
                                                            <div class="row">
                                                                ...
                                                                <?php
                                                                //    echo"1TTTTTTTTTTTT:". $rec['current_sequence']." ".$rec['status']."<br>";

                                                                if ($row['sequence_no'] == 1 && $rec['status'] != 'Completed') {
                                                                ?>
                                                                    <div class="col-md-4"><span class="font-weight-bold text-info">On Process</span></div>
                                                                    <?php
                                                                } else if ($row['sequence_no'] >= 2) {
                                                                    if ($rec['status'] == 'Completed') {
                                                                        // echo"22TTTTTTTTTTTT:". $rec['current_sequence']." ".$rec['status']."<br>";
                                                                    ?>
                                                                    ...
                                                                    <?php
                                                                        ...
                                                                        // echo"22TTTTTTTTTTTT:". $rec['current_sequence']." ".$rec['status'];
                                                                    ?>
                                                                        <div class="col-md-4"><span class="font-weight-bold text-info">On Process</span></div>
                                                                    <?php
                                                                    }
                                                                    ...
                                                                    <div class="col-md-4"><span class="font-weight-bold text-info">Completed [<?php echo date('d/m/Y', strtotime($helper->appraisalGetCompletedDate2('appraisal_dean_observation', $id, $info['staffId'], 'date_submitted'))); ?>]</span></div>
                                                                <?php
                                                                    // echo "33TTTTTTTTTTTT:" . $rec['current_sequence'] . " " . $rec['status'] . "<br>";
                                                                }
                                                                ?>
                                                        ...
                                                        // echo "NNNNNNNNNNNNN:" . $rec['current_sequence'];
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane p-20" id="StaffTraining" role="tabpanel">
                                                <div class="card">
                                                    <div class="card-header bg-light-info p-b-0 p-t-5">
                                                        <h4 class="card-title font-weight-bold">Training Courses Received by the Employee During This Year [<i>To be filled by the employee تعبأ من قبل الموظف</i>]</h4>
                                                    </div>
                                                    <div class="card-body">
                                                        <?php
                                                        if ($checkSubmitted->totalCount != 0) {
                                            ...
                                            <div class="tab-pane p-20" id="SelfAppraisal" role="tabpanel">
                                                ...
                                                ?>
                                                    <form novalidate>
                                                        ...
                                                        <div class="card">
                                                            <div class="card-header bg-light-success p-b-0 p-t-5">
                                                                <h4 class="card-title">Self Observation [<i>To be filled by the employee تعبأ من قبل الموظف</i>]</h4>
                                                            </div>
                                                            <div class="card-body">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        ?>
                                                            <form class="form-horizontal" action="" method="POST" novalidate enctype="multipart/form-data">
                                                                ...
                                                                <?php
                                                                } if($info['department']== 'Deans Office' )
                                                                {
                                                                    ?>
                                                                    <div class="form-group row m-b-0">
                                                                        <div class="offset-sm-8 col-sm-4">
                                            ...
                                            <div class="tab-pane p-20" id="Observation" role="tabpanel">
                                                ...
                                                <div class="tab-pane p-20" id="Approval" role="tabpanel">
                                                     <div class="card">
                                                        <?php
                                                        if (isset($_POST['submitADDEanApproval'])) {
                                                            ...
                                                            if ($helper->insert("appraisal_dean_observation", $fields)) {
                                                                ...
                                                                $sql = "UPDATE appraisal_admin SET status = 'Completed' WHERE id = $id";
                                                                $helper->executeSQL($sql);
                                                                $contact_details = new DbaseManipulation;
                                                                $gsm = $contact_details->getContactInfo(1, $staff_id, 'data');
                                                                $staff_email = $contact_details->getContactInfo(2, $staff_id, 'data');
                                                                $get = new DbaseManipulation;
                                                                $rowREqNo = $get->singleReadFullQry("SELECT TOP 1 requestNo FROM appraisal_admin WHERE id = $id");
                                                                $newReqNo = $rowREqNo['requestNo'];
                                                                $appName = $get->getStaffName($staff_id, 'firstName', 'secondName', 'thirdName', 'lastName');
                                                                $getIdInfo = new DbaseManipulation;
                                                                ...
                                                                if ($emailParticipants->smtpMailer($to, $from_name, $from, $subject, $message)) {
                                                                    ...
                                                                    $emailFields = [
                                                                        'requestNo' => $newReqNo,
                                                                        'moduleName' => 'Admin - Staff Appraisal Approved By The Dean',
                                                                        'sentStatus' => 'Sent',
                                                                        'recipients' => $recipients,
                                                                        'fromName' => $from_name,
                                                                        'comesFrom' => $from,
                                                        ...
                                                        $deanRow = $dean->singleReadFullQry("SELECT TOP 1 * FROM appraisal_dean_observation WHERE appraisal_type_description_id = 3 AND appraisal_id = $appraisal_admin_id"); //3 is fixed for admin
                                                        if ($dean->totalCount != 0) {
                                                            $tobeVisibleLast = '';
                                                        } else {
                                                            $tobeVisibleLast = '[To be filled by the ADAA/College Dean]';
                                                        }
                                                        ?>
                                                        <div class="card-header bg-light-success p-b-0 p-t-5"><h4 class="card-title">Asst. Dean/College Dean Approval <?=$appraisal_admin_id ?> <?=$myPositionId?>_____<i><?php echo $tobeVisibleLast; ?></i></h4></div>
                                                        <div class="card-body">
                                                            <?php
                                                            if ($dean->totalCount != 0) {
                                                            ?>
                                                                    <form novalidate>
                                                                        <div class="form-group row m-b-5 m-t-0">
                                                                            ...
                                                                            <div class="col-sm-9">
                                                                                ...
                                                                                $rowAgree = $agree->singleReadFullQry("SELECT * FROM appraisal_hod_observation WHERE appraisal_type_description_id = 3 AND appraisal_id = $appraisal_admin_id");
                                                        ...
                                                        ?>
                                                            <form class="form-horizontal" action="" method="POST" novalidate enctype="multipart/form-data">
                                                                ...
                                                                if ($myPositionId <= 4) {
                                                                    $approval = new DbaseManipulation;
                                                                    $approval->singleReadFullQry("SELECT TOP 1 * FROM appraisal_admin WHERE id = $appraisal_admin_id AND current_approver = $myPositionId");
                                                                    if ($approval->totalCount != 0) {
                                                                ?>
                                                                        <div class="form-group row m-b-0">
                                                                            <div class="offset-sm-2 col-sm-10">
                                                                                <button type="submit" name="submitADDEanApproval" class="btn btn-info waves-effect waves-light"><i class="fa fa-paper-plane"></i> Submit Approvals</button>
                                                                            </div>
                                                                        </div>
                                                                <?php
                                                                    }
