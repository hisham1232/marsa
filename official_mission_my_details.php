    ...
    if(!$helper->isUserLogged()) {
        ...
        if($allowed){
            if(isset($_GET['id'])) {
                ...
                $result = $leave->singleReadFullQry("SELECT s.id, s.requestNo, l.name as leave_type, s.dateFiled, s.startDate, s.endDate, s.total, s.modified, s.currentStatus, s.reason, s.attachment FROM standardleave as s LEFT OUTER JOIN leavetype as l ON s.leavetype_id = l.id WHERE s.requestNo = '$id' AND s.staff_id = '$staffId'");
                        ...
                        <div class="container-fluid">
                            <div class="row page-titles">
                                <div class="col-md-5 col-xs-18 align-self-center">
                                    <h3 class="text-themecolor m-b-0 m-t-0">My Official Duty Details</h3>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item">Home</a></li>
                                        <li class="breadcrumb-item">Official Duty</li>
                                        <li class="breadcrumb-item">My Official Duty List</li>
                                        <li class="breadcrumb-item">Official Duty Details</li>
                                    </ol>
                                </div>
                                                            ...
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    <div class="d-flex flex-wrap">
                                                                        <div>
                                                                            <h3 class="card-title">Official Duty Application Details</h3>
                                                                    ...
                                                                    <div class="form-group row">
                                                                            <label  class="col-sm-3 control-label">Current Status <br> عتاريخ الطلب</label>
                                                                            <div class="col-sm-9">
                                                                                <div class="controls">
                                                                        ...
                                                                        <div class="form-group row">
                                                                            <label  class="col-sm-3 control-label"><span class="text-danger">*</span>Official Duty Date</label>
                                                                            <div class="col-sm-9">
                                                                        ...
                                                                        <div class="form-group row stateYourReason">
                                                                            <label  class="col-sm-3 control-label"><span class="text-danger">*</span>Why cancel leave? <br>سبب الإجازة</label>
                                                                            <div class="col-sm-9">
                                                                                <div class="controls">
                                                                                    <div class="input-group">
                                                                        ...
                                                                        <?php
                                                                            if($result['currentStatus'] == 'Pending') { //Only pending leaves can be cancelled.
                                                                        ?>    
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    <div class="d-flex flex-wrap">
                                                                        <div>
                                                                            <h3 class="card-title">Official Duty Approval Sequence</h3>
                                                                            <h6 class="card-subtitle">Arabic Text Here</h6>
                                                                        </div>
                                                                    </div>
                                                                    <?php
                                                                ...
                                                                <div class="card-body">
                                                                    <a href="pdf_single_official_mission.php?staffId=<?php echo $staffId; ?>&requestNo=<?php echo $id; ?>" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Print</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                    ...
                    $(document).ready(function () {
                        ...
                        $('.proceeedCancelApplication').click(function(){
                            ...
                            if(cancel_reason == "") {
                                ...
                                ajaxLoader("notification_for_approvals_actions.php","id="+id+"&notes="+cancel_reason+"&requestNo="+request_no+"&action=1&approvalType=OMcancel",".actionComplete");
                            }    
                        });
                    });
                    /*-------------------------------------------------------------------------------------------------------------------*/
