                            ...
                            <div class="row page-titles">
                                <div class="col-md-5 col-xs-18 align-self-center">
                                    ...
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item">Grievance Statistics - By Respondent</li>
                                    </ol>
                                </div>
                                ...
                                <div class="col-lg-12 col-md-18 col-xs-18"><!---start for list div-->
                                    <div class="card bg-light-warning2">
                                        <div class="card-header bg-light-warning2" style="border-bottom: double; border-color: #28a745">
                                            <h4 class="card-title">Grievance Statistics - By Respondent</h4>
                                                ...
                                                <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th>Has Number of Grievance Offended</th>
                                                        </tr>
                                                    </thead>
                                                    <?php 
                                                        if(isset($_POST['submit'])) {
                                                            ...
                                                            <tbody>
                                                                <?php
                                                                    ...
                                                                    $rows = $complainants->readData("SELECT distinct(g.responder) as responder, concat(ss.firstName,' ',ss.secondName,' ',ss.thirdName,' ',ss.lastName) as respondentName FROM grievance as g LEFT OUTER JOIN staff as ss ON g.responder = ss.staffId AND g.date_filed >= '$startDate' AND g.date_filed <= '$endDate'");
                                                                    ...
                                                                    foreach ($rows as $row) {
                                                                        ...
                                                                        <tr>
                                                                            <td><?php echo ++$i.'.'; ?></td>
                                                                            <td><a href="grievance_list_all.php?sid=<?php echo $row['responder']; ?>"><?php echo $row['respondentName']; ?></a></td>
                                                                            <td><?php echo $statCount->responderCountDate($row['responder'],$startDate,$endDate,'bilang'); ?></td>
                                                                        </tr>
                                                                        <?php
                                                                    }
                                                                ?>
                                                            ...
                                                            <tbody>
                                                                <?php
                                                                    $complainants = new DbaseManipulation;
                                                                    $rows = $complainants->readData("SELECT distinct(g.responder) as responder, concat(ss.firstName,' ',ss.secondName,' ',ss.thirdName,' ',ss.lastName) as respondentName FROM grievance as g LEFT OUTER JOIN staff as ss ON g.responder = ss.staffId");
                                                                    $statCount = new DbaseManipulation;
                                                                    $i = 0;
                                                                    foreach ($rows as $row) {
                                                                        ?>
                                                                        <tr>
                                                                            <td><?php echo ++$i.'.'; ?></td>
                                                                            <td><a href="grievance_list_all.php?sid=<?php echo $row['responder']; ?>"><?php echo $row['respondentName']; ?></a></td>
                                                                            <td><?php echo $statCount->responderCount($row['responder'],'bilang'); ?></td>
                                                                        </tr>
                                                                        <?php
                                                                    }
                                                                ?>
