                        ...
                        <div class="container-fluid">
                            <div class="row page-titles">
                                <div class="col-md-5 col-xs-18 align-self-center">
                                    <h3 class="text-themecolor m-b-0 m-t-0">Grievance Complaint Against Me</h3>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item">Home</a></li>
                                        <li class="breadcrumb-item">Grievance  </li>
                                        <li class="breadcrumb-item">Complaint Against Me</li>
                                    </ol>
                                </div>
                                                    ...
                                                    <tbody>
                                                        <?php 
                                                            ...
                                                            if(isset($_POST['submit'])) {
                                                                ...
                                                                FROM grievance as g 
                                                                INNER JOIN employmentdetail as e ON g.complainant = e.staff_id
                                                                INNER JOIN staff as s ON g.complainant = s.staffId 
                                                                INNER JOIN department as d ON d.id = e.department_id
                                                                WHERE g.responder = '$staffId' AND e.isCurrent = 1 AND g.view_responder = 1";
                                                                if ($_POST['status'] != '') {
                                                                ...
                                                                foreach ($rows as $row) {
                                                                    ...
                                                                    ?>
                                                                        <tr class="<?php echo $class; ?>">
                                                                            <td><?php echo ++$i.'.'; ?></td>
                                                                            <td><a href="grievance_details_responder.php?id=<?php echo $row['id']; ?>"><?php echo $row['staffName']; ?></a></td>
