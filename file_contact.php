                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="d-flex flex-wrap">
                                                <div>
                                                    <h3 class="card-title">Add New Contact Type</h3>
                                                    <h6 class="card-subtitle">اضافة نوع الاتصال</h6> 
                                                </div>
                                            </div>
                                            <?php 
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="controls">
                                                            <div class="input-group">
                                                                <input type="text" name="name" class="form-control" required data-validation-required-message="Please type the contact type name" /> 
                                                            </div><!--end input-group-->
                                                        </div><!--end controls-->
                                                    </div><!--end col-sm-9-->
                                ...
                                <div class="col-lg-6"><!---start for list div-->
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h6 class="card-subtitle">قائمة بأنواع التواصل</h6>
