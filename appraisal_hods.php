                                ...
                                <div class="col-md-5 col-xs-18 align-self-center">
                                    <?php 
                                        ...
                                        if($helper->totalCount != 0) {
                                            $titleHeader = 'Staff Appraisal';
                                            $titleForm = 'Staff Appraisal Form - ';
                                        } else {
                                            $titleHeader = 'Staff Appraisal - HOD';
                                            $titleForm = 'Staff Appraisal Form - HOD';
                                        }
                                    ?>
                                    <h3 class="text-themecolor m-b-0 m-t-0"><?php echo $titleHeader; ?></h3>
                                    <ol class="breadcrumb">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-header bg-light-success" style="border-bottom: double; border-color: #28a745">
                                            <div class="d-flex no-block align-items-center">
                                                <h4 class="card-title font-weight-bold"><?php echo $titleForm; ?> [<?php echo $appraisalYear; ?>]</h4>
                                                <div class="ml-auto">
                                                    <ul class="list-inline text-right">
                                                        <?php 
                                                            ...
                                                            $rec = $checkSubmitted->singleReadFullQry("SELECT TOP 1 * FROM appraisal_hod WHERE staff_id = '$staffId' AND appraisal_year = '$currentYear' ORDER BY id DESC");
                                                        ...
                                                        <li><a href="appraisal_hod_view.php?id=1" target="_blank" class="btn btn-sm btn-warning waves-effect waves-light" title="Click to Show the Appraisal Result to Staff"><i class="fas fa-search"></i> View Result</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="tab-pane p-20" id="SelfAppraisal" role="tabpanel">
                                                    <?php 
                                                        if(isset($_POST['submitHOD'])) {
                                                            ...
                                                            $checkRequest->singleReadFullQry("SELECT TOP 1 id, requestNo FROM appraisal_hod WHERE requestNo = '$requestIdNumber' ORDER BY id DESC");
                                                            if($checkRequest->totalCount != 0) {
                                                                $req = new DbaseManipulation;
                                                                $newReqNo = $req->requestNo("HOD-","appraisal_hod");    
                                                            } else {
                                                            ...
                                                            $fields = [
                                                                ...
                                                                'appraisal_type'=>5,
                                                                'status'=>'Submitted by the HOD/HOC',
                                                            ...
                                                            if($saveTech->insert("appraisal_hod",$fields)){
                                                                ...
                                                                $message .= "<tr style='background:#E0F8F7; width:400px'><td><strong>STATUS:</strong> </td><td>Submitted By The HOD</td></tr>";
                                                                ...
                                                                if($emailParticipants->smtpMailer($to,$from_name,$from,$subject,$message)){
                                                                    ...
                                                                    $emailFields = [
                                                                        'requestNo'=>$newReqNo,
                                                                        'moduleName'=>'HOD - Staff Appraisal Submitted',
                                                                        'sentStatus'=>'Sent',
                                                        ...
                                                        if($checkSubmitted->totalCount != 0) {
                                                            ...
                                                            <form id="techForm" method="POST" action="" novalidate>
                                                                ...
                                                                <div class="text-xs-right">
                                                                    ...
                                                                    <button type="submit" name="submitHOD" class="btn btn-info waves-effect waves-light"><i class="fa fa-paper-plane"></i> Submit Appraisal</button>
