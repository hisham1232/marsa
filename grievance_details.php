                                        ...
                                        <div class="card-body bg-light-warning2">
                                            ...
                                            <div class="ribbon-wrapper card">
                                                ...
                                                <?php
                                                    ...
                                                    $g = $checkGrievance->singleReadFullQry("SELECT status, position_id FROM grievance WHERE id = $gid");
                                                ...
                                                <?php 
                                                    $complainant_position_id = $g['position_id'];
                                                    $checkVisibility = new DbaseManipulation;
                                                    $sql = "SELECT * FROM grievance_workflow WHERE approver_id = $myPositionId AND category_id = $cateGoryaId AND position_id = $complainant_position_id";
                                                    ...
                                                    if($checkVisibility->totalCount != 0) {
                                                        ...
                                                        $checkSequence->singleReadFullQry("SELECT * FROM grievance WHERE id = $gid");
                                                        //echo "SELECT * FROM grievance WHERE id = $gid AND current_sequence_no = $sequence_no";
                                                                ...
                                                                <div class="card-body bg-light p-r-5 p-l-5">
                                                                    ...
                                                                    <form class="form-horizontal" action="" method="POST" novalidate enctype="multipart/form-data">
                                                                        ...
                                                                        <div class="form-group row m-b-5 m-t-0">
                                                                            ...
                                                                            <label  class="col-sm-2 control-label" style="<?php echo $class; ?>">Is Visible to Responder?</label>
                                                                            <div class="col-sm-4" style="<?php echo $class; ?>">
                                                                                <div class="controls">
                                                                                    <div class="input-group">
