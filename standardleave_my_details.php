                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6"> 
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <?php $emrLeaveBal = $bal->getEmergencyLeaveBalance($staffId,'balance'); ?>
                                                        <div class="col-2"><h5 class="text-primary"><?php echo $emrLeaveBal; ?></h5></div>
                                                        <div class="col-5"> 
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <?php $emrLeavePen = $bal->getEmergencyLeavePending($staffId,'balance'); ?>
                                                        <div class="col-2"><h5 class="text-primary"><?php echo $emrLeavePen; ?></h5></div>
                                                        <div class="col-5"> 
