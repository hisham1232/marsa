                                    ...
                                    <div class="card">
                                        <div class="card-header bg-light-info">
                                            <div class="d-flex flex-wrap">
                                                <div>
                                                    <h3 class="card-title">Add New Standard Leave Approval Sequence Form for Position <p class="font-weight-bold text-primary">Department: [<span class="font-weight-bold text-primary"><?php echo $staff_department; ?></span>]<br>Position: [<span class="addNewPosition"></span>]</p></h3>
