                                    ...
                                    <div class="card border-success">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <ul class="nav nav-tabs" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link active" data-toggle="tab" href="#sl" role="tab">
                                            ...
                                            <div class="tab-content tabcontent-border p-10">
                                                <div class="tab-pane active" id="sl" role="tabpanel">
                                                    <?php
                                                        ...
                                                        WHERE sh.currentApproverPositionId = $myPositionId AND sh.currentSeqNumber = 1 AND sh.currentStatus = 'Pending'
                                                        ORDER BY sh.id DESC";
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                ?>
                                                                                            <tr>
                                                                                                ...
                                                                                                <td><a href="javascript:;" data-id="<?php echo $row['id']; ?>" data-requestno="<?php echo $row['requestNo']; ?>" class="btn btn btn-outline-info btn-sm viewShortLeaveDetails" role="button" aria-pressed="true" title="Click to view details"><i class="fas fa-angle-double-right"></i> View</a></td>
                                                                                            </tr>
                                                                                <?php
                                                                                        }
                                                                                    }
