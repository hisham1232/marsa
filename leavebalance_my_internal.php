<?php    
    ...
    if(!$helper->isUserLogged()) {
        ...
        if($allowed){
            ...
            WHERE e.isCurrent = 1 AND s.staffId = '$staffId'");
                        ...
                        <div class="container-fluid">
                            <div class="row page-titles">
                                <div class="col-md-5 col-xs-18 align-self-center">
                                    <h3 class="text-themecolor m-b-0 m-t-0">My Internal Leave Balance</h3>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item">Home</a></li>
                                        <li class="breadcrumb-item">My Internal Balance </li>
                                    </ol>
                                </div>
                                            ...
                                            <div class="table-responsive">
                                                <table id="intLeaveBalanceHistory" class="display table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                            $i = 0; 
                                                            $rows = $data->readData("SELECT i.*, l.name as leavetype FROM internalleavebalancedetails as i LEFT OUTER JOIN leavetype as l ON l.id = i.leavetype_id WHERE i.staffId = '$staffId' ORDER BY i.id");
                                                            $runningBalance = 0;
                                                            foreach ($rows as $row) {
                                                                $staffId = $row['staffId'];
                                                                if ($row['addType'] == 1) 
                                                        ...
                                                        ?>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        ?>
                                                                                <a href="standardleave_my_details.php?id=<?php echo $row['internalleavebalance_id']; ?>&uid=<?php echo $staffId; ?>"><?php echo $row['internalleavebalance_id']; ?></a>
                                                                        <?php
                                                                            } else {
                                                                    ...
                                                                    <td><?php echo "<span class='text-primary'>".$row['status']." </span><small class='text-mute'>[Reason: ".$row['notes']."]</small>"; ?></td>
