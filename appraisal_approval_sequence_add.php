<?php    
    ...
    if(!$helper->isUserLogged()) {
        ...
        if($allowed){
            if(isset($_GET['did'])) {
                $staff_department = $helper->fieldNameValue("department",$_GET['did'],'name');
                $did = $_GET['did'];
            } else {
...
?>  
            <body class="fix-header fix-sidebar card-no-border">
                <style type="text/css">
                    .modal-body { /*For History Modal, using bootbox.alert*/
                        height: 500px;
                        overflow-y: scroll;
                    }
                </style>
                        ...
                        <div class="container-fluid">
                            <div class="row page-titles">
                                <div class="col-md-5 col-8 align-self-center">
                                    <h3 class="text-themecolor m-b-0 m-t-0">Appraisal Approval Sequence Details</h3>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item">Home</a></li>
                                        <li class="breadcrumb-item">Staff Appraisal</li>
                                        <li class="breadcrumb-item">Approval Sequence</li>
                                    ...
                                    <div class="card">
                                        <div class="card-header bg-light-info">
                                            <div class="d-flex flex-wrap">
                                                <div>
                                                    <h3 class="card-title">Add New Staff Appraisal Approval Sequence Form for Position <p class="font-weight-bold text-primary">Department: [<span class="font-weight-bold text-primary"><?php echo $staff_department; ?></span>]<br>Position: [<span class="addNewPosition"></span>]</p></h3>
                                        ...
                                        <div class="card-body">
                                            <?php
                                                //Dito tumigil, kailangan ma save mo ito sa tamang table appraisal_approval_sequence
                                                if(isset($_POST['submitApprovalSequence'])){
                                                    ...
                                                    $appraisal_type_id = $_POST['appraisal_type_id'];
                                                    ...
                                                    $upd->executeSQL("UPDATE appraisal_approval_sequence SET active = 0 WHERE sequence_no = $sequenceNo AND position_id = $position_id AND department_id = $department_id");
                                                    if($save->insert("appraisal_approval_sequence",$fields)){
                                                        ?>
                                            ...
                                            <form class="form-horizontal p-t-20 p-l-0 p-" action="" method="POST" novalidate enctype="multipart/form-data">
                                                <div class="form-group row">
                                                    <label  class="col-lg-3 control-label"><span class="text-danger">*</span>College Position</label>
                                                    <div class="col-lg-9">
                                                        <div class="controls">
                                                            <div class="input-group">
                                                                <input type="hidden" name="id" class="id" />
                                                                <input type="hidden" name="sequence_no" class="sequence_no" />
                                                                <input type="hidden" name="previous_approver" class="previous_approver" />
                                                                <input type="hidden" name="department_id" value="<?php echo $did; ?>" />
                                                                <select name="position_id" class="form-control select2 position_id" required data-validation-required-message="Please select college position">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <div class="controls">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="hidden" name="previous_approver" class="previous_approver" />
                                                                <input type="hidden" name="department_id" value="<?php echo $did; ?>" />
                                                                <select name="approver_id" class="form-control select2 approver_id" required data-validation-required-message="Please select college position">
                                                ...
                                                <div class="form-group row">
                                                    <label  class="col-lg-3 control-label">Approver Name</label>
                                                    <div class="col-lg-9">
                                                        <div class="controls">
                                                            <div class="input-group">
                                                ...
                                                <div class="form-group row">
                                                    <label  class="col-lg-3 control-label"><span class="text-danger">*</span>Appraisal Type</label>
                                                    <div class="col-lg-9">
                                                        <div class="controls">
                                                            <div class="input-group">
                                                                <select name="appraisal_type_id" class="form-control appraisal_type_id" required data-validation-required-message="Please select appraisal type">
                                                                    <option value="">Select</option>
                                                                    <option value="1">Technician</option>
                                                                    <option value="2">Lecturer</option>
                                                                    <option value="3">Administrative Staff</option>
                                                                    <option value="4">Head Of Section</option>
                                                                    <option value="5">Head Of Center/Department</option>
                                                                    <option value="6">Administrative Manager</option>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <div class="controls">
                                                            <div class="input-group">
                                                                <select name="statActive" class="form-control statActive" required data-validation-required-message="Please select status">
                                                ...
                                                <div class="form-group row">
                                                    <label  class="col-lg-3 control-label"><span class="text-danger">*</span>Sequence</label>
                                                    <div class="col-lg-9">
                                                        <div class="controls">
                                                            <div class="input-group">
                                                                <select name="sequenceNo" class="form-control">
                                                ...
                                                <div class="form-group row">
                                                    <label  class="col-lg-3 control-label"><span class="text-danger">*</span>Is Final Approver</label>
                                                    <div class="col-lg-9">
                                                        <div class="controls">
                                                            <div class="input-group">
                                                ...
                                                <div class="form-group row m-b-0">
                                                    <div class="offset-sm-3 col-lg-9">
                                                        <button type="submit" name="submitApprovalSequence" class="btn btn-info waves-effect waves-light submitApprovalSequence"><i class="fa fa-paper-plane"></i> Submit Add New</button>
                                                        <!-- <button type="submit" name="updateApprovalSequence" class="btn btn-info waves-effect waves-light updateApprovalSequence" style='display:none'><i class="fa fa-paper-plane"></i> Update</button> -->
                                ...
                                <div class="col-lg-8 col-sm-18"><!---start for list div-->
                                    <div class="card">
                                        <div class="card-header bg-light-info">
                                            <div class="d-flex flex-wrap">
                                                <div>
                                                    <h4 class="card-title">Department: [<span class="font-weight-bold text-primary"><?php echo $staff_department; ?></span>]</h4>
                                                ...
                                                <table id="dynamicTable" class="display table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                            ...
                                                            FROM appraisal_approval_sequence as a 
                                                            ...
                                                            if($fetchApprovers->totalCount != 0) {
                                                                foreach($rows as $row){
                                                                    ?>
                                                                        <tr>
                                                                            <td><?php echo $row['sequence_no'].'.'; ?></td>
                                                                            <td><a class="text-success approverTitleClick" style="cursor:pointer" data-id="<?php echo $row['id']; ?>" data-approver_id="<?php echo $row['approver_id']; ?>" data-sequence_no="<?php echo $row['sequence_no']; ?>" data-statactive="<?php echo $row['active']; ?>"><?php echo $row['approverTitle']; ?></a></td>
                ...
                <script>
                    ...
                    $(".approver_id").change(function() {
                        ...
                        var data = {
                            position_id : approver_id
                        }
                        $.ajax({
                            url	 : 'ajaxpages/leaves/settings/queryaddnew.php'
                            ,type	 : 'POST'
                            ,dataType: 'json'
                            ,data	 : data
                            ,success : function(e){
                    ...
                    $(".position_id").change(function() {
                        var college_position_name = $( ".position_id option:selected" ).text();
                        $('.addNewPosition').text(college_position_name);
                        ...
                        $.ajax({
                            ...
                            ,success : function(e){
                                if(e.error == 1){
                                    ...
                                    //$('.position_id').empty();
                                    $('.position_id').append($('<option selected>').text(e.approver_position).attr('value', e.approver_id));
