                                        ...
                                        <div class="card-header bg-light-success" style="border-bottom: double; border-color: #28a745">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    <?php
                                                        /* 
                                                        $status = $helper->singleReadFullQry("SELECT status FROM appraisal_technician WHERE id = ".$rec['id']);
                                                        ...
                                                        <div class="card-body">
                                                            <?php 
                                                                if(isset($_POST['submitGeneralAttribute'])) {
                                                                    ...
                                                                    if($helper->insert("appraisal_technician_general_attribute",$fields)) {
                                                                        ?>
                                                                        <script>
                                                                    ...
                                                                    <form method="POST" action="" novalidate>
                                                                        <div class="demo-radio-button">
                                                                            ...
                                                                            <div class="row border-bottom m-t-5">
                                                                                <div class="col-lg-5 col-xs-18">Having the interest to update knowledge and learn new experiments</div>
                                                                                <div class="col-lg-2 col-xs-18">
                                                                                    <input name="job_q13[]" type="radio" id="job_q13_a" value="5" class="with-gap radio-col-indigo" checked />
                                                                            ...
                                                                            <div class="row border-bottom m-t-5">
                                                                                ...
                                                                                <div class="col-lg-2 col-xs-18">
                                                                                    <input name="job_q20[]" type="radio" id="job_q20_b" value="4" class="with-gap radio-col-indigo" checked />
                                                                                    <label for="job_q20_b">Very Good</label>
                                                                                </div>
                                                                                 <div class="col-lg-1 col-xs-18">
                                                                                    <input name="job_q20[]" type="radio" id="job_q20_c" value="3" class="with-gap radio-col-indigo" checked />
                                                                                    <label for="job_q20_c">Good</label>
                                                                                </div>
                                                                                <div class="col-lg-1 col-xs-18">
                                                                                    <input name="job_q20[]" type="radio" id="job_q20_d" value="2" class="with-gap radio-col-indigo" checked />
                                                                            ...
                                                                            <div class="row border-bottom m-t-5">
                                                                                <div class="col-lg-5 col-xs-18"><h3>Total/Remark</h3></div>
                                                                                <div class="col-lg-5">
                                                                                    <label><h3><span id="totalScore">20</span> - <span id="totalRemarks">Weak</span></h3></label>
                                                                                </div>
                                                                            </div><!--end row total-->
                                                                        </div><!--end demo-radio-button-->
                                                                    ...
                                                                    if($helper->insert("appraisal_trainings",$fields)) {
                                                                        ...
                                                                        if($_POST['textarea6'] != '') {
                                                                            $fields6 = [
                                                                                ...
                                                                                'appraisal_type_id'=>$_GET['id'],
                                                                                'staff_id'=>$staff_id,
                                                                                'development_needed'=>$_POST['textarea6'],
                                                                                'submitted_by'=>$staffId,
                                                                                'date_submitted'=>date('Y-m-d H:i:s',time()),
                                                                                'appraisal_year'=>$appraisalYear
                                                                            ];
                                                                            $helper->insert("appraisal_trainings",$fields6);
                                                                        }
                                                                        if($_POST['textarea7'] != '') {
                                                                            $fields7 = [
                                                                                'appraisal_type_description_id'=>1,
                                                                                'appraisal_type_id'=>$_GET['id'],
                                                                                'staff_id'=>$staff_id,
                                                                                'development_needed'=>$_POST['textarea7'],
                                                                                'submitted_by'=>$staffId,
                                                                                'date_submitted'=>date('Y-m-d H:i:s',time()),
                                                                                'appraisal_year'=>$appraisalYear
                                                                            ];
                                                                            $helper->insert("appraisal_trainings",$fields7);
                                                                        }
                                                                        ?>
                                                                        <script>
                                                                            $(document).ready(function() {
                                                                    ...
                                                                    <form class="form-horizontal" action="" method="POST" novalidate enctype="multipart/form-data">
                                                                        <div class="form-group row m-b-5 m-t-0">
                                                                            <div class="col-sm-10">
                                                                                <div class="controls">
                                                                                    <div class="input-group">
                                                                                        <textarea name="textarea1" rows="2" id="textarea" class="form-control" required data-validation-required-message="Please enter at least one course and training program. Put Not Applicable if you don't want to." title="Recommnded courses and training programs"></textarea>
                                                                                        <div class="input-group-prepend">
                                                                                            <span class="input-group-text" id="basic-addon2">
                                                                                                <a class="mytooltip" href="javascript:void(0)"> 
                                                                                                    <i class="fas fa-info-circle"></i>
                                                                        ...
                                                                        <div class="form-group row m-b-5 m-t-0">
                                                                            <div class="col-sm-10">
                                                                                <div class="controls">
                                                                                    <div class="input-group">
                                                                                        <textarea name="textarea2" rows="2" id="textarea" class="form-control" title="Recommnded courses and training programs"></textarea>
                                                                                        <div class="input-group-prepend">
                                                                                            <span class="input-group-text" id="basic-addon2">
                                                                                                <a class="mytooltip" href="javascript:void(0)"> 
                                                                                                    <i class="fas fa-info-circle"></i>
                                                                        ...
                                                                        <div class="form-group row m-b-5 m-t-0">
                                                                            <div class="col-sm-10">
                                                                                <div class="controls">
                                                                                    <div class="input-group">
                                                                                        <textarea name="textarea3" rows="2" id="textarea" class="form-control" title="Recommnded courses and training programs"></textarea>
                                                                                        <div class="input-group-prepend">
                                                                                            <span class="input-group-text" id="basic-addon2">
                                                                                                <a class="mytooltip" href="javascript:void(0)"> 
                                                                                                    <i class="fas fa-info-circle"></i>
                                                                        ...
                                                                        <div class="form-group row m-b-5 m-t-0">
                                                                            <div class="col-sm-10">
                                                                                <div class="controls">
                                                                                    <div class="input-group">
                                                                                        <textarea name="textarea4" rows="2" id="textarea" class="form-control" title="Recommnded courses and training programs"></textarea>
                                                                                        <div class="input-group-prepend">
                                                                                            <span class="input-group-text" id="basic-addon2">
                                                                                                <a class="mytooltip" href="javascript:void(0)"> 
                                                                                                    <i class="fas fa-info-circle"></i>
                                                                        ...
                                                                        <div class="form-group row m-b-5 m-t-0">
                                                                            <div class="col-sm-10">
                                                                                <div class="controls">
                                                                                    <div class="input-group">
                                                                                        <textarea name="textarea5" rows="2" id="textarea" class="form-control" title="Recommnded courses and training programs"></textarea>
                                                                                        <div class="input-group-prepend">
                                                                                            <span class="input-group-text" id="basic-addon2">
                                                                                                <a class="mytooltip" href="javascript:void(0)"> 
                                                                                                    <i class="fas fa-info-circle"></i>
                                                                        ...
                                                                        <div class="form-group row m-b-5 m-t-0">
                                                                            <div class="col-sm-10">
                                                                                <div class="controls">
                                                                                    <div class="input-group">
                                                                                        <textarea name="textarea6" rows="2" id="textarea" class="form-control" title="Recommnded courses and training programs"></textarea>
                                                                                        <div class="input-group-prepend">
                                                                                            <span class="input-group-text" id="basic-addon2">
                                                                                                <a class="mytooltip" href="javascript:void(0)"> 
                                                                                                    <i class="fas fa-info-circle"></i>
                                                                        ...
                                                                        <div class="form-group row m-b-5 m-t-0">
                                                                            <div class="col-sm-10">
                                                                                <div class="controls">
                                                                                    <div class="input-group">
                                                                                        <textarea name="textarea7" rows="2" id="textarea" class="form-control" title="Recommnded courses and training programs"></textarea>
                                                                                        <div class="input-group-prepend">
                                                                                            <span class="input-group-text" id="basic-addon2">
                                                                                                <a class="mytooltip" href="javascript:void(0)"> 
                                                                                                    <i class="fas fa-info-circle"></i>
                                                            ...
                                                            <?php 
                                                                if(isset($_POST['submitHOSObservation'])) {
                                                                    ...
                                                                    if($helper->insert("appraisal_hos_observation",$fields)) {
                                                                        ...
                                                                        $sql = "UPDATE appraisal_technician SET status = 'Approved by the Direct Manager', current_approver = $approver_id, current_sequence = $sequence_no_next WHERE id = ".$_GET['id'];
                                                                        ...
                                                                        if($emailParticipants->smtpMailer($to,$from_name,$from,$subject,$message)){
                                                                            ...
                                                                            $emailFields = [
                                                                                'requestNo'=>$newReqNo,
                                                                                'moduleName'=>'Technician - Staff Appraisal Approved By Direct Manager (HOS)',
                                                                                'sentStatus'=>'Sent',
                ...
                <script>
                    $(document).ready(function() {
                        ...
                        $('input:radio').change(function(){
                            //var radioValue = $("input[name='job_q1']:checked").val();
                            ...
                            var totalValue = parseInt(job_q1) + parseInt(job_q2) + parseInt(job_q3) + parseInt(job_q4) + parseInt(job_q5) + parseInt(job_q6) + parseInt(job_q7) + parseInt(job_q8) + parseInt(job_q9) + parseInt(job_q10) + parseInt(job_q11) + parseInt(job_q12) + parseInt(job_q13) + parseInt(job_q14) + parseInt(job_q15) + parseInt(job_q16) + parseInt(job_q17) + parseInt(job_q18) + parseInt(job_q19) + parseInt(job_q20);
                            if(totalValue){
                                if(totalValue >= 90 && totalValue <= 100)
                                    ...
                                    var remarks = 'Good';
                                else if(totalValue >= 56 && totalValue <= 69)
                                    var remarks = 'Fair';
