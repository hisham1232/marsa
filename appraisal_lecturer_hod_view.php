                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div class="tab-pane p-20" id="Attribute" role="tabpanel">
                                                    <div class="card">
                                                        ...
                                                        ?>
                                                        <div class="card-header bg-light-success p-b-0 p-t-5">
                                                            <h4>General Attribute ??<i> <?php  echo $appraisal_lecturer_id;  echo $tobeVisible; ?></i></h4>
                                                        </div>
                                                        <div class="card-body">
                                                            <?php 
                                                                if($genAtt->totalCount != 0) {
                                                ...
                                                <div class="tab-pane p-20" id="Approval" role="tabpanel">
                                                    <div class="card">
                                                        <?php 
                                                            ...
                                                            //echo "SELECT TOP 1 * FROM appraisal_hod_observation WHERE appraisal_type_description_id = 2 AND appraisal_id = $appraisal_lecturer_id";
                                                                        ...
                                                                        if($dean->totalCount != 0) {
                                                                            ...
                                                                            <form class="form-horizontal" action="" method="POST" novalidate>
                                                                                ...
                                                                                <?php 
                                                                                    if($myPositionId <= 4) {
                                                                                        $approval = new DbaseManipulation;
                                                                                        $approval->singleReadFullQry("SELECT TOP 1 * FROM appraisal_lecturer WHERE id = $appraisal_lecturer_id AND current_approver = $myPositionId");
                                                                                        if($approval->totalCount != 0) {
                                                                                            ?>
                                                                                            <div class="form-group row m-b-0">
                                                                                                <div class="offset-sm-2 col-sm-10">
