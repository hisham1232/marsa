                                        ...
                                        <div class="card-body">
                                            ...
                                            <ul class="feeds">
                                                <li>
                                                    ...
                                                    <a href="staff_profile.php?id=<?php echo $primary_staff_id; ?>" class="text-dark" title="Click to view Staff Profile"> My Profile</a> <span class="pull-right"><a class="btn btn-primary" href="staff_qualification.php?id=<?php echo $primary_staff_id; ?>"><i class="fa fa-edit"></i> Update Your Information Now!</a></span></li>
                                                <li>
                                                    <?php
                                                        ...
                                                        ?>        
                                                                ...
                                                                <span>
                                                                    ...
                                                                    <?php
                                                                        ...
                                                                        if(is_numeric($lid)) {
                                                                            ...
                                                                            ?>
                                                                                <a href="shortleave_approve.php?linkid=<?php echo $lid; ?>" title="Click to View Short Leave Request" class="btn btn-sm waves-effect waves-light text-danger">Short &nbsp;
                                                                                <?php 
                                                                                    if($countSL['sLCount'] > 0) {
                                                                                        ?>    
                                                                                        <span class="badge badge-danger Blink"><?php echo $countSL['sLCount']; ?></span></a>&nbsp;&nbsp;
                                                                                        <?php 
                                                                                    } else {
                                                                                        ?>    
                                                                                        <span class="badge badge-danger"><?php echo $countSL['sLCount']; ?></span></a>&nbsp;&nbsp;
                                                                                        <?php 
                                                                                    }
                                                                                ?>
                                                                    ...
                                                                    <?php
                                                                        ...
                                                                        if(is_numeric($lid)) {
                                                                            if($amIStandardLeaveApprover == 1 && $countSTL['sTLCount'] > 0) { //Listed as standard leave approver in approvalsequence_standardleave table > approver_id
                                                                                ?>
                                                                                <a href="standardleave_approve.php?linkid=<?php echo $lid; ?>" title="Click to View Standard Leave Request" class="btn btn-sm waves-effect waves-light text-danger">Standard &nbsp;
                                                                                    <?php 
                                                                                        if($countSTL['sTLCount'] > 0) {
                                                                                            ?>    
                                                                                            <span class="badge badge-danger Blink"><?php echo $countSTL['sTLCount']; ?></span></a>&nbsp;&nbsp;
                                                                                            <?php 
                                                                                        } else {
                                                                                            ?>    
                                                                                            <span class="badge badge-danger"><?php echo $countSTL['sTLCount']; ?></span></a>&nbsp;&nbsp;
                                                                                            <?php 
                                                                                        }
                                                                                    ?> 
                                                                                <?php
                                                                    ...
                                                                    <?php
                                                                        ...
                                                                        if(is_numeric($lid)) {
                                                                            ...
                                                                            ?>
                                                                                <a href="official_mission_approve.php?linkid=<?php echo $lid; ?>" title="Click to View Official Mission Request" class="btn btn-sm waves-effect waves-light text-danger">Official Mission &nbsp;
                                                                                <?php 
                                                                                    if($countOM['OMCount'] > 0) {
                                                                                        ?>    
                                                                                        <span class="badge badge-danger Blink"><?php echo $countOM['OMCount']; ?></span></a>&nbsp;&nbsp;
                                                                                        <?php 
                                                                                    } else {
                                                                                        ?>    
                                                                                        <span class="badge badge-danger"><?php echo $countOM['OMCount']; ?></span></a>&nbsp;&nbsp;
                                                                                        <?php 
                                                                                    }
                                                                            } else {
                                                                            ?>
                                                                    ...
                                                                    <?php
                                                                        ...
                                                                        if(is_numeric($lid)) {
                                                                            ...
                                                                            ?>
                                                                                <a href="overtime_approve.php?linkid=<?php echo $lid; ?>" title="Click to View Overtime Leave Request" class="btn btn-sm waves-effect waves-light text-danger">Overtime &nbsp;
                                                                                <?php 
                                                                                    if($countOvertime['OTCount'] > 0) {
                                                                                        ?>    
                                                                                        <span class="badge badge-danger Blink"><?php echo $countOvertime['OTCount']; ?></span></a>&nbsp;&nbsp;
                                                                                        <?php 
                                                                                    } else {
                                                                                        ?>    
                                                                                        <span class="badge badge-danger"><?php echo $countOvertime['OTCount']; ?></span></a>&nbsp;&nbsp;
                                                                                        <?php 
                                                                                    }
                                                                                ?>
                                                                            <?php
                                                            ...
                                                            <li>
                                                                ...
                                                                <span>
                                                                    ...
                                                                    ?>
                                                                    <a href="clearance_my_approvals_list.php?linkid=<?php echo $lid; ?>" title="Click to View Clearance Request Which is For Your Approval" class="btn btn-sm waves-effect waves-light text-danger">Clearance Application &nbsp;
                                                                    <?php 
                                                                        if($countCLR['clearanceCount'] > 0) {
                                                                            ?>    
                                                                            <span class="badge badge-danger Blink"><?php echo $countCLR['clearanceCount']; ?></span></a>
                                                                            <?php 
                                                                        } else {
                                                                            ?>    
                                                                            <span class="badge badge-danger"><?php echo $countCLR['clearanceCount']; ?></span></a>
                                                                            <?php 
                                                                        }
                                                                    ?>        
                                                                </span>
                                                    ...
                                                    <ul class="feeds">
                                                        <li>
                                                            ...
                                                            <?php
                                                                ...
                                                                $lid = $helper->linkId($page_id,$user_type,'id');
                                                                if(is_numeric($lid)) {
                                                                    $getToday = new DbaseManipulation;
                                                                    $nowDate = date('Y-m-d',time()).' 00:00:01';
                                                                    $endDate = date('Y-m-d',time()).' 23:59:59';
                                                                    $row = $getToday->singleReadFullQry("SELECT COUNT(*) as todayCount FROM standardleave WHERE dateFiled >= '$nowDate' AND dateFiled <= '$endDate'");
                                                                    ?>
                                                                        <span>
                                                                            <a href="standardleave_list_today.php?linkid=<?php echo $lid; ?>" title="Click to New View Standard Leave Request" class="btn btn-sm waves-effect waves-light text-info">New Standard Leave &nbsp;<span class='badge badge-danger'><?php echo $row['todayCount']; ?></span></a>
                                                                        </span>
                                                                    <?php      
                                                                }
                                                            ?>
                                                        ...
                                                        <li>
                                                            ...
                                                            <?php
                                                                ...
                                                                $lid = $helper->linkId($page_id,$user_type,'id');
                                                                if(is_numeric($lid)) {
                                                                    $getTodaySL = new DbaseManipulation;
                                                                    $nowDateSL = date('Y-m-d');
                                                                    $row = $getTodaySL->singleReadFullQry("SELECT COUNT(*) as todayCount FROM shortleave WHERE dateFile = '$nowDateSL'");
                                                                    ?>
                                                                        <span>
                                                                            <a href="shortleave_list_today.php?linkid=<?php echo $lid; ?>" title="Click to View New Short Leave Request" class="btn btn-sm waves-effect waves-light text-info">New Short Leave &nbsp;<span class='badge badge-danger'><?php echo $row['todayCount']; ?></span></a>
                                                                        </span>
                                                                    <?php      
                                                                }
                                                            ?>
                                                        ...
                                                        <li>
                                                            ...
                                                            <span>
                                                                ...
                                                                ?>
                                                                <a href="notification_document_expiration.php" title="Click to Staff with Document will expire soon" class="btn btn-sm waves-effect waves-light text-danger">Document Expiration 
                                                                    <?php 
                                                                        if($tagaBilang > 0) {
                                                                            ?>
                                                                            &nbsp;<span class="badge badge-danger Blink"><?php echo $tagaBilang; ?></span></a>
                                                                            <?php
                                                                        } else {
                                                                            ?>
                                                                            &nbsp;<span class="badge badge-danger"><?php echo $tagaBilang; ?></span></a>
                                                                            <?php
                                                                        }
                                                                    ?>
