<?php    
    ...
    if(!$helper->isUserLogged()) {
        ...
        if($allowed || $staffId = '404009' || $staffId = '196058'){ //Customized for the Auditor (196058) and Database Admin, Mr. Ali                             
?>  
                            ...
                            <div class="row page-titles">
                                <div class="col-md-5 col-xs-18 align-self-center">
                                    ...
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item">Search Staff Attendance </li>
                                    </ol>
                                </div>
                                        ...
                                        <form action="" method="POST" novalidate enctype="multipart/form-data">
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label">Select Staff Name</label>
                                                    <div class="col-sm-8">
                                                        <select name="staff_id" class="form-control select2" required data-validation-required-message="Please select staff from the list">
                                            ...
                                            <div class="row">
                                                ...
                                                <?php
                                                    if(isset($_POST['searchByDate'])){
                                                        ...
                                                        $info = $basic_info->singleReadFullQry("SELECT s.id, s.staffId, concat(s.firstName,' ',s.secondName,' ',s.thirdName,' ',s.lastName) as staffName, s.gender, d.name as department, sp.name as sponsor, j.name as jobtitle, e.status_id FROM staff as s LEFT OUTER JOIN employmentdetail as e ON s.staffId = e.staff_id LEFT OUTER JOIN department as d ON d.id = e.department_id LEFT OUTER JOIN sponsor as sp ON sp.id = e.sponsor_id LEFT OUTER JOIN jobtitle as j ON j.id = e.jobtitle_id WHERE s.staffId = '$staff_id'");
                                                    }    
                                                ?>
                                                        ...
                                                        <?php
                                                            if(isset($_POST['searchByDate'])){
                                                                ...
                                                                for($i=$ctr-1; $i>=0; $i--) {
                                                                    ...
                                                                    //echo "SELECT * FROM v_attendance WHERE StaffId = '$staffId' AND Date >= '$newDateRanges[$i]' AND Date <= '$newDateRanges[$i]'<br>";
                                                                                        ...
                                                                                        if($qryCheckLeave->totalCount != 0) { //No Attendance BUT there is a LEAVE FILED.
                                                                                            if($chkLeave['currentStatus'] == 'Cancelled' || $chkLeave['currentStatus'] == 'Declined'){
                                                                                                ...
                                                                                                ?>
                                                                                                    ...
                                                                                                    <td></td>
                                                                                                    <td></td>
                                                                                                    <td><span class="bg-onleave">On Leave A</span></td>
                                                                                                    <td><?php echo $chkLeave['leavetype']; ?></td>
