                        ...
                        <div class="container-fluid">
                            <div class="row page-titles">
                                <div class="col-md-5 col-xs-18 align-self-center">
                                    <h3 class="text-themecolor m-b-0 m-t-0">Grievance Statistics - By Status</h3>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item">Home</a></li>
                                        <li class="breadcrumb-item">Grievance  </li>
                                        <li class="breadcrumb-item">Grievance Statistics - By Status</li>
                                    </ol>
                                </div>
                                ...
                                <div class="col-lg-12 col-md-18 col-xs-18"><!---start for list div-->
                                    <div class="card bg-light-warning2">
                                        <div class="card-header bg-light-warning2" style="border-bottom: double; border-color: #28a745">
                                            <h4 class="card-title">Grievance Statistics - By Status</h4>
                                        </div><!--end card header-->
                                        <div class="card-body">
                                                                ...
                                                                if($load->totalCount != 0) {
                                                                    ...
                                                                    foreach ($rows as $row) {
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td><?php echo $statistic->countGrievanceStatDate($row['id'],'OPEN',$startDate,$endDate,'statCountStatus'); ?></td>
                                                                            <td><?php echo $statistic->countGrievanceStatDate($row['id'],'SOLVED',$startDate,$endDate,'statCountStatus'); ?></td>
                                                                            <td><?php echo $statistic->countGrievanceStatTotalDate($row['id'],$startDate,$endDate,'statCountStatusTotal'); ?></td>
                                                                        </tr>
                                                                        <?php
                                                                    }
                                                                }
                                                                ...
                                                                if($load->totalCount != 0) {
                                                                    ...
                                                                    foreach ($rows as $row) {
                                                                        ...
                                                                        <tr>
                                                                            <td><?php echo ++$i.'.'; ?></td>
                                                                            <td><?php echo $row['department']; ?></td>
                                                                            <td><?php echo $statistic->countGrievanceStat($row['id'],'OPEN','statCountStatus'); ?></td>
                                                                            <td><?php echo $statistic->countGrievanceStat($row['id'],'SOLVED','statCountStatus'); ?></td>
                                                                            <td><?php echo $statistic->countGrievanceStatTotal($row['id'],'statCountStatusTotal'); ?></td>
                                                                        </tr>
                                                                        <?php
                                                                    }
                                                                }
