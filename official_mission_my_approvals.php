                        ...
                        <div class="container-fluid">
                            <div class="row page-titles">
                                <div class="col-md-5 col-8 align-self-center">
                                    <h3 class="text-themecolor m-b-0 m-t-0">My Approvals Official Duty Request List</h3>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item">Home</a></li>
                                        <li class="breadcrumb-item">Official Duty</li>
                                        <li class="breadcrumb-item">My Approvals List</li>
                                    </ol>
                                </div>
                                ...
                                <div class="col-lg-12"><!---start for list div-->
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            ?>
                                            <h4 class="card-title">OFFICIAL DUTY REQUEST APPROVALS (ALREADY APPROVED BY [<?php echo trim($info['staffName']); ?> - <?php echo $info['department']; ?> - <?php echo $info['sponsor']; ?>])</h4>
                                            <h6 class="card-subtitle">قائمة طلبات مهام العمل التي قمت بإعتمادها</h6>
                                                        ...
                                                        <?php
                                                            ...
                                                            if($data->totalCount != 0) {
                                                                    foreach ($rows as $row) {
                                                                        ...
                                                                        <tr>
                                                                            <td><?php echo ++$i.'.'; ?></td>
                                                                            <td><a href="official_duty_my_approvals_details.php?id=<?php echo $row['standardleave_id']; ?>&uid=<?php echo $row['staff_id']; ?>"><?php echo $row['requestNo']; ?></a></td>
