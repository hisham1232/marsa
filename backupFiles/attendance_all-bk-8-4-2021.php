                                    ...
                                    <div class="card card-body p-b-0">
                                        <form id="form-attendance" method="POST" action="">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-4">
                                                    <select name="department_id[]" id="department_id" class="form-control select2 m-b-10 select2-multiple" style="width: 100%" multiple="multiple" data-placeholder="All">
                                                        <?php 
                                                            $rows = $helper->readData("SELECT id, name FROM department ORDER BY id");
                                                            foreach ($rows as $row) {
                                                        ?>
                                                ...
                                                <div class="col-sm-4">
                                                    <select name="section_id[]" id="section_id" class="form-control select2 m-b-10 select2-multiple" style="width: 100%" multiple="multiple" data-placeholder="All">
                                                        <?php 
                                                            $rows = $helper->readData("SELECT id, name FROM section ORDER BY id");
                                                            foreach ($rows as $row) {
                                                        ?>
                                                                <option value="<?php echo $row['id']; ?>"><?php echo $row['name']; ?></option>
                                                        <?php            
                                            ...
                                            <div class="form-group row">    
                                                ...
                                                <div class="col-sm-4">
                                                    <select name="sponsor_id[]" id="sponsor_id" class="form-control select2 m-b-10 select2-multiple" style="width: 100%" multiple="multiple" data-placeholder="All">
                                                        <?php 
                                            ...
                                            <div class="form-group row">    
                                                ...
                                                <div class="col-sm-4">
                                                    <select name="attendance_status[]" id="attendance_status" class="form-control select2 m-b-10 select2-multiple attendance_status" style="width: 100%" multiple="multiple" data-placeholder="All">
                                                        ...
                                                        <?php
                                                            if(isset($_POST['searchBtn'])){
                                                                ...
                                                                if ($_POST['department_id'] != '') {
                                                                    ...
                                                                    $qryText .= " AND e.department_id IN (".$departmentIds.")";
                                                                }
                                                                ...
                                                                if ($_POST['section_id'] != '') {
                                                                    ...
                                                                    $qryText .= " AND e.section_id IN (".$sectionIds.")";
                                                                }
                                                                ...
                                                                if ($_POST['sponsor_id'] != '') {
                                                                    ...
                                                                    $qryText .= " AND e.sponsor_id IN (".$sponsorIds.")";
                                                                }

                                                                if ($_POST['attendance_status'] != '') {
                                                                    $attStatus = array();
                                                                    foreach ($_POST['attendance_status'] as $selectedAttStats) {
                                                                        array_push($attStatus,$selectedAttStats);
                                                                    }
                                                                    $attStatus = implode(' ', $attStatus);
                                                                }
                                                                
                                                                //echo $qryText;
                                                                echo "<input type='hidden' id='astat' value='".$attStatus."'>";
