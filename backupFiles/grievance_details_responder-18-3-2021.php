<?php    
    ...
    if(!$helper->isUserLogged()) {
        ...
        $info = $check->singleReadFullQry("SELECT COUNT(id) as bilang FROM grievance WHERE id = $gid AND view_responder = 1");
        $cateGoryaId = $helper->fieldNameValue('grievance',$gid,'category_id');
        $bilang = $info['bilang'];
        if($bilang > 0)
            $allowed = true;
            //$allowed = (($helper->isAllowed('SuperAdmin') || $helper->isAllowed('HRHead') || $helper->isAllowed('HRStaff') || $helper->isAllowed('HoD_HoC') || $helper->isAllowed('HoS') || $helper->isAllowed('Approver')) || $staffId == '119084' || $staffId == '121101' || $staffId == '107036') ? true : false;
        else
            $allowed =  false;
                                    ...
                                    <div class="card m-t-0 m-b-0">
                                        ...
                                        <div class="card-body bg-light-warning2">
                                            ...
                                            <div class="ribbon-wrapper card">
                                                ...
                                                <!-------THIS FORM IS VISIBLE ONLY TO THE RESPONDER-------->
                                                <?php
                                                    $checkGrievance = new DbaseManipulation;
                                                    $g = $checkGrievance->singleReadFullQry("SELECT status, date_filed, view_responder FROM grievance WHERE id = $gid");

                                                    if(($staffId == $responderId) && $g['status'] == 'OPEN') {
                                                        ?>
                                                        <?php 
                                                            if(isset($_POST['submitTwo'])) {                                                                
                                                                ...
                                                                if($save->insert("grievance_history",$fields)){
                                                                    if($_POST['decision'] == 'Agree') {
                                                                        ...
                                                                        $message .= "<tr style='background:#E0F8F7; width:400px'><td><strong>STATUS:</strong> </td><td>CLOSED</td></tr>";
                                                                        ...
                                                                        $from_name = 'hrms@nct.edu.om';
                                                                        $from = 'HRMS - 3.0';
                                                                        $subject = 'NCT-HRMD GRIEVANCE UNRESOLVED HAS BEEN COMMENTED BY '.strtoupper($logged_name);
                                                                        $message = '<html><body>';
                                                                        $message .= '<img src="http://apps.nct.edu.om/hrmd2/img/hr-logo-email.png" width="419" height="65" />';
                                                                        $message .= "<h3>NCT-HRMS 3.0 GRIEVANCE DETAILS</h3>";
                                                                        $message .= '<table style="border-color:#666; width:800px" cellpadding="10">';
                                                                        ...
                                                                        if($emailParticipants->smtpMailer($to,$from_name,$from,$subject,$message)){
                                                                            ...
                                                                            $emailFields = [
                                                                                'requestNo'=>$gid,
                                                                                'moduleName'=>'Grievance Application Responder Comment',
                                                                                'sentStatus'=>'Sent',
                                                                                'recipients'=>$recipients,
                                                                                'fromName'=>$from_name,
                                                                                'comesFrom'=>$from,
                                                                            ...
                                                                            $emailFields = [
                                                                                'requestNo'=>$gid,
                                                                                'moduleName'=>'Grievance Application Reponder Comment',
                                                                                'sentStatus'=>'Failed',
                                                                                'recipients'=>$recipients,
                                                                                'fromName'=>$from_name,
                                                                                'comesFrom'=>$from,
                                                            ...
                                                            $dateFiled = date('Y-m-d H:i:s',strtotime($g['date_filed']));
                                                            $dateNow = date('Y-m-d H:i:s');
                                                            $dateStart = strtotime($dateFiled);
                                                            $dateEnd = strtotime($dateNow);
                                                            $interval = $dateEnd - $dateStart;
                                                            $noOfDays = round($interval / (60 * 60 * 24)) + 1;
                                                            if($noOfDays >= 3) {
                                                                ?>
                                                                <label  class="col-sm-12 control-label text-danger"><?php echo $noOfDays; ?> Entering comment has been disabled by the system since this grievance was filed 3 days ago.</label>
                                                                <?php   
                                                            } else {
                                                                if($g['view_responder'] == 1) {   
                                                                    ?>                
                                                            ...
                                                            if(isset($_POST['submitAppeal'])) {                                                                
                                                                $fields = [
                                                                    'grievance_id'=>$gid,
                                                                    'staffId'=>$staffId,
                                                                    'statement'=>'DECISION APPEALED. '.$_POST['reasonAppeal'],
                                                                    'decision'=>'Appealed',
                                                                    'dateEntered'=>date('Y-m-d H:i:s',time())
                                                                ];                                                                
                                                                $save = new DbaseManipulation;
                                                                if($save->insert("grievance_history",$fields)){
                                                                    if($_POST['decision'] == 'Agree') {
                                                                        ...
                                                                        $from_name = 'hrms@nct.edu.om';
                                                                        $from = 'HRMS - 3.0';
                                                                        $subject = 'NCT-HRMD GRIEVANCE APPEALED BY '.strtoupper($logged_name);
                                                                        $message = '<html><body>';
                                                                        $message .= '<img src="http://apps.nct.edu.om/hrmd2/img/hr-logo-email.png" width="419" height="65" />';
                                                                        $message .= "<h3>NCT-HRMS 3.0 GRIEVANCE DETAILS</h3>";
                                                                        $message .= '<table style="border-color:#666; width:800px" cellpadding="10">';
                                                                        $message .= "<tr style='background:#E0F8F7; width:400px'><td><strong>STATUS:</strong> </td><td>Appealed</td></tr>";
                                                                        $message .= "<tr style='background:#EFFBFB; width:400px'><td><strong>REQUEST ID:</strong> </td><td>".$gid."</td></tr>";
                                                                        $message .= "<tr style='background:#E0F8F7'><td><strong>DATE FILED:</strong> </td><td>".date('M d, Y h:i:s A',strtotime($detail['date_filed']))."</td></tr>";
                                                                        $message .= "<tr style='background:#EFFBFB'><td><strong>RESPONDENT STAFF ID:</strong> </td><td>".$responderId."</td></tr>";
                                                                        $message .= "<tr style='background:#E0F8F7'><td><strong>RESPONDENT NAME:</strong> </td><td>".$respondentName."</td></tr>";
                                                                        ...
                                                                        if($emailParticipants->smtpMailer($to,$from_name,$from,$subject,$message)){
                                                                            ...
                                                                            $emailFields = [
                                                                                'requestNo'=>$gid,
                                                                                'moduleName'=>'Grievance Application Appeal',
                                                                                'sentStatus'=>'Sent',
                                                                                'recipients'=>$recipients,
                                                                                'fromName'=>$from_name,
                                                                                'comesFrom'=>$from,
                                                        ...
                                                        <div class="card-body bg-light p-r-5 p-l-5">
                                                            <form class="form-horizontal" action="" method="POST" novalidate enctype="multipart/form-data">
                                                                <div class="form-group row m-b-5 m-t-0">
                                                                    <label class="col-sm-3 control-label">Reason for your appeal</label>
                                                                    <div class="col-sm-9">
                                                                        <div class="controls">
                                                                            <div class="input-group">
                                                                                <script type="text/javascript">
                                                                                    function success() {
                                                                                        if(document.getElementById("reasonAppeal").value==="") { 
                                                                                            document.getElementById('submitAppeal').disabled = true; 
                                                                                        } else { 
                                                                                            document.getElementById('submitAppeal').disabled = false;
                                                                                        }
                                                                                    }
                                                                                </script>
                                                                                <textarea name="reasonAppeal" id="reasonAppeal" onkeyup="success()" rows="2" class="form-control" required data-validation-required-message="Please enter Statement"></textarea>
                                                                                <div class="input-group-prepend">
                                                                                    <span class="input-group-text" id="basic-addon2">
                                                                                        <i class="far fa-comment"></i>
                                                                                    </span>
                                                                ...
                                                                <div class="form-group row m-b-5 m-t-0">
                                                                    <div class="offset-sm-3 col-sm-9">
                                                                        <button type="submit" name="submitAppeal" id="submitAppeal" class="btn btn-info waves-effect waves-light" disabled><i class="fa fa-paper-plane"></i> I want to appeal on the decision.</button>
                                                                        <button type="reset" class="btn btn-inverse waves-effect waves-light"><i class="fa fa-retweet"></i> Reset</button>
                                                                    </div>
                                                                </div>
                                                            </form>
                                                ...
                                                <?php 
                                                    ...
                                                    if($checkVisibility->totalCount != 0) {
                                                                ...
                                                                <div class="card-body bg-light p-r-5 p-l-5">
                                                                    <?php 
                                                                        if(isset($_POST['submit1'])) {
                                                                            if($_POST['view_responder'] == 1) {
                                                                                $sqlUpdateGrievance = "UPDATE grievance SET view_responder = 1 WHERE id = $gid";
                                                                                $checkSequence->executeSQL($sqlUpdateGrievance);
                                                                                //array_push($to,$respondentEmail);
                                                                                $statement = $_POST['statement'].'. - Responder has been involved in the process.';
                                                                            } else {
                                                                    ...
                                                                    <form class="form-horizontal" action="" method="POST" novalidate enctype="multipart/form-data">
                                                                        ...
                                                                        <div class="form-group row m-b-5 m-t-0">
                                                                            ...
                                                                            <label  class="col-sm-2 control-label">Is Visible to Responder?</label>
                                                                            <div class="col-sm-4">
                                                                                <div class="controls">
                                                                                    <div class="input-group">
                                                                                        <select name="view_responder" class="form-control">
