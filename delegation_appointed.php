                        ...
                        <div class="container-fluid">
                            <div class="row page-titles">
                                <div class="col-md-5 col-xs-18 align-self-center">
                                    <h3 class="text-themecolor m-b-0 m-t-0">My Delegation List</h3>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                                        <li class="breadcrumb-item">Delegation</li>
                                        <li class="breadcrumb-item">My Delegation List</li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <?php
                                        $rows = $helper->readData("SELECT d.*, concat(s.firstName,' ',s.secondName,' ',s.thirdName,' ',s.lastName) as delegated_staff FROM delegation as d LEFT OUTER JOIN staff as s ON s.staffId = d.staffIdTo WHERE d.staffIdTo = '$staffId'");
                                        if($helper->totalCount != 0) {
                                            ?>
                                            <div class="card">
                                                <div class="card-header bg-light-info p-t-5 p-b-0">
                                                    <h4 class="card-title">List of Delegation Appointed To [<?php echo $logged_name; ?>] </h4>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    ?>    
                                                                                            ...
                                                                                            <?php /*<button type="button" title="Click to Extend Delegation" class="btn btn btn-outline-primary btn-sm extendDelegation" data-toggle="modal" data-target="#extendModal" data-id="<?php echo $row['id']; ?>" data-requestno="<?php echo $row['requestNo']; ?>" data-delegated_staff="<?php echo $row['delegated_staff']; ?>" data-status="<?php echo $row['status']; ?>" data-datefiled="<?php echo date('d/m/Y H:i:s',strtotime($row['created'])); ?>" data-duration="From <?php echo date('d/m/Y',strtotime($row['startDate'])); ?> To <?php echo date('d/m/Y',strtotime($row['endDate'])); ?>" data-note="<?php echo $row['reason']; ?>"><i class="fas fa-edit fa-2x"></i></button>*/ ?>
                                                                                    <?php
