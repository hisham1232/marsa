<?php
    ...
    $sql = "SELECT d.*, concat(s.firstName,' ',s.secondName,' ',s.thirdName,' ',s.lastName) as delegator FROM delegation as d LEFT OUTER JOIN staff as s ON s.staffId = d.staffIdFrom WHERE d.staffIdTo = '$staff_id' AND d.startDate <= '$start_date' AND d.endDate >= '$end_date' AND d.status NOT IN ('Finished');";
