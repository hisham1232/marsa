<?php
    ...
    if($checkHistory->totalCount != 0) {
        ...
        $table .=    
                ...
                <div class="d-flex flex-wrap">
                    <div>
                        <h4 class="text-dark">Leave Date: '.date('F m, Y',strtotime($info['leaveDate'])).'</h4>
                    </div>
                    <div class="ml-auto">
                        <ul class="list-inline">
                            <li class="none">
                                <h4 class="text-dark">Duration: From '.$info['startTime'].' to '.$info['endTime'].'</h4>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="d-flex flex-wrap">
                    ...
                    <div class="ml-auto">
                        <ul class="list-inline">
                            <li class="none">
                                <h4 class="text-dark">No. of Hours: '.$info['total'].'</h4>
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex flex-wrap">
                                <div>
                                    ...
                                    <h6 class="card-subtitle">سجل إعتماد الإجازة</h6>
                                </div>
                            </div>';
                            foreach($rows as $row){
                                $table .='
