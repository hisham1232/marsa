...
<body class="fix-header fix-sidebar card-no-border">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">Approve Standard Leave</li>
                        </ol>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="profiletimeline">
                                            <div class="sl-item">
                                                <div class="sl-left">
                                                    <img src="<?php echo 'https://www.nct.edu.om/images/staff-photos/'.$staffId.'.jpg'; ?>"
                                                        class="img-circle" alt="Staff Image"><br>
                                                    <input type="hidden" class="approverStaffId"
                                                        value="<?php echo $staffId; ?>" />
                                                    <input type="hidden" class="approverEmail"
                                                        value="<?php echo $logged_in_email; ?>" />
                                                </div>
                                                <div class="sl-right">
                                                    <div><a href="javascript:;"
                                                            class="link"><?php echo $logged_name; ?></a> <span
                                                            class="sl-date">[Staff ID : <?php echo $staffId; ?>]</span>
                                                        <div class="like-comm">
                                                            <?php
                                                                            //Standard Leave Counter
                                                                            ...
                                                                            //This is the old code, it queries all leave type that is why even the official duty is being reflected here since Official Duty is a leave type before with an id of 13...
                                                                            ...
                                                                            //This should be the correct query, omitting the leavetype_id 13 which is official duty...
                                                                            $countSTL = $helper->singleReadFullQry("SELECT count(id) as sTLCount FROM standardleave WHERE current_approver_id = $myPositionId AND currentStatus = 'Pending' AND leavetype_id != 13");
                                                                            $totalApprovals = $countSTL['sTLCount'];
                                                                        ?>
                                                            <a href="javascript:void(0)" class="link m-r-5">You have
                                                                [<?php echo $totalApprovals; ?>] for Approvals
                                                                waiting</a>
                                                        </div>
                                                    </div>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active" data-toggle="tab" href="#stl" role="tab">
                                            ...
                                            <span class="hidden-xs-down">
                                                <span class="hidden-xs-down"><i class="ti-angle-double-down"></i>
                                                    Standard Leave
                                                    <?php
                                                                if($totalApprovals > 0) {
                                                                ?>
                                                    <span
                                                        class="badge badge-pill badge-danger font-weight-bold"><?php echo $totalApprovals; ?></span>
                                                    <?php
                                                                } else {
                                                            ?>
                                ...
                                <div class="tab-content tabcontent-border p-10">
                                    <div class="tab-pane active" id="stl" role="tabpanel">
                                        <?php
                                                        ...
                                                        WHERE stl.current_approver_id = $myPositionId AND stl.currentStatus = 'Pending' AND e.isCurrent = 1 AND leavetype_id != 13 ORDER BY stl.id";
                                                        //echo $sql;
                                        ...
                                        <div class="card">
                                            <div class="card-header bg-light-success2">
                                                <h3 class="card-title">Standard Leave For Approvals List <span
                                                        class="text-danger">[<?php echo $totalApprovals; ?> -
                                                        application to approve]</span></h3>
                                                <div class="row">
                                                    <div class="col-6">
                                                        <p class="m-0 p-0 text-primary">To Quick APPROVE or Decline
                                                            Application:</p>
                                                        <p class="m-0 p-0">1. Click the <span
                                                                class="font-weight-bold">application</span> the list or
                                                            click <span class="font-weight-bold">SELECT ALL</span>
                                                            button</p>
                                                        <p class="m-0 p-0">2. Click <span
                                                                class="font-weight-bold">APPROVE</span> or <span
                                                                class="font-weight-bold">DECLINE</span> button below</p>
                                                    </div>
                                                    <div class="col-6">
                                                        <p class="m-0 p-0 text-primary">To VIEW the details of the
                                                            application:</p>
                                                        <p class="m-0 p-0">1. Click the <span
                                                                class="font-weight-bold">View Details</span> button on
                                                            Action column</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card-body">
                                                <div class="table-responsive">
                                                    <table id="standardLeaveTable"
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php echo $row['staff_id']." - ".$row['staffName']; ?>
                                                                </td>
                                                                <td><?php echo $row['department']; ?></td>
                                                                <td><?php echo $row['sponsor']; ?></td>
                                                                <td><?php echo $row['leaveType']; ?></td>
                                                                <td><?php echo date('d/m/Y',strtotime($row['startDate'])).' to '.date('d/m/Y',strtotime($row['endDate'])); ?>
                                                                </td>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <button
                                                                        class='btn btn-outline-danger btn-sm viewAttachment'
                                                                        data-toggle='modal'
                                                                        data-target='#modalAttachment'><i
                                                                    ...
                                                                    <a href="javascript:;"
                                                                        ...
                                                                        data-requestno="<?php echo $row['requestNo']; ?>"
                                                                        class="btn btn btn-outline-info btn-sm viewStandardLeaveDetails"
                                                    ...
                                                    <button type="button" class="btn btn-danger StLDeclineSelected"><i
                                                            class="fas fa-thumbs-down"></i> DECLINE Selected
                                                        Records</button>
                                                    <button type="button" class="btn btn-primary StLApproveSelected"><i
                                                            class="fas fa-thumbs-up"></i> APPROVE Selected
                                                        Records</button>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card-body bg-light-danger2">
                                                <div class="d-flex flex-wrap">
                                                    <div style="margin:auto !important;">
                                                        <h1 class="text-info"
                                                            style="font-size: 110px !important; font-weight: 700 !important;line-height: 110px !important; text-align: center !important;">
                                                            <center><i class="fas fa-clipboard-list"></i></center>
                                                        </h1>
                                                        <h2 class="text-danger">NO Records Waiting for APPROVAL Found!
                                                        </h2>
                                                    </div>
                                                </div>
                                            </div>
    ...
    $(document).ready(function() {
        function ajaxLoader(linkPage, variables, divName) {
            $(divName).empty().html(
                "<i class='fa fa-info-circle text-warning'></i> <span class='text-warning'>Processing your action, please wait</span> <img src='scripts/ajax-loader.gif'/>"
            );
                ...
                bootbox.confirm({
                    ...
                    callback: function(result) {
                        if (result == true) {
                            ...
                            ajaxLoader("notification_for_approvals_actions.php",
                                "requestNoS=" + iDsSelected + "&approverId=" +
                                approverId + "&approverEmail=" + approverEmail +
                                "&action=1&approvalType=stl", ".processingRequest");
                    ...
                    callback: function(result) {
                        if (result == true) {
                            ...
                            ajaxLoader("notification_for_approvals_actions.php",
                                "requestNoS=" + iDsSelected + "&approverId=" +
                                approverId + "&approverEmail=" + approverEmail +
                                "&action=4&approvalType=stl", ".processingRequest");
                            $('.btn-bootbox-yes').hide();
                            $('.btn-bootbox-no').hide();
                            return false;
                        }
                            ...
                            buttons: {
                                decline: {
                                    ...
                                    callback: function(result) {
                                        ...
                                        var approverId = $('.approverStaffId')
                                            .val();
                                        ...
                                        if (notes == '') {
                                            bootbox.alert(
                                                "<strong class='text-danger'><i class='fa fa-exclamation-triangle'></i> Unable To Continue!</strong><br/><br/>Your notes or comments must not be blank."
                                            );
                                            return false;
                                        } else {
                                            ajaxLoader(
                                                "notification_for_approvals_actions.php",
                                                "id=" + id +
                                                ...
                                                "&no_of_days=" +
                                                no_of_days +
                                                "&action=3&approvalType=stl",
                                                ".STLApprovedConfirmation");
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-light-danger2">
                    <h4 class="modal-title" id="exampleModalLabel1"><i class="fas fa-file-pdf"></i> Leave Attachment
                    </h4>
