                                                        ...
                                                        if($helper->totalCount != 0) {
                                                            ...
                                                            <div class="card">
                                                                <div class="card-header bg-light-success2">
                                                                    <h3 class="card-title">Standard Leave For Approvals List <span class="text-danger">[<?php echo $totalApprovals; ?> - application to approve]</span></h3>
                                                                    <div class="row">
                                                                        <div class="col-6">
                                                ...
                                                decline: {
                                                    ...
                                                    callback: function(result){
                                                        ...
                                                        if(notes == '') {
                                                            ...
                                                            ajaxLoader("notification_for_approvals_actions.php","id="+id+"&requestNoS="+requestNo+"&approverId="+approverId+"&approverEmail="+approverEmail+"&notes="+notes+"&position_id="+position_id+"&no_of_days="+no_of_days+"&action=3&approvalType=stl",".STLApprovedConfirmation");
                                                ...
                                                ok: {
                                                    ...
                                                    callback: function (result) {
                                                        ...
                                                        if(notes == '') {
                                                            ...
                                                            ajaxLoader("notification_for_approvals_actions.php","id="+id+"&requestNoS="+requestNo+"&approverId="+approverId+"&approverEmail="+approverEmail+"&notes="+notes+"&position_id="+position_id+"&no_of_days="+no_of_days+"&action=2&approvalType=stl",".STLApprovedConfirmation");
                                                            $('.btn-bootbox-approve').hide();
                                                            $('.btn-bootbox-decline').hide();
                                                            $('.btn-bootbox-close').hide();
                                                            return false;
