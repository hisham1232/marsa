                                                                                ...
                                                                                <table data-toggle="table"  data-mobile-responsive="true" class="table">
                                                                                    ...
                                                                                    <tbody>
                                                                                        <?php
                                                                                            ...
                                                                                            $pos = $distinct_position_id->readData("SELECT DISTINCT p.position_id, sp.title FROM approvalsequence_standardleave as p LEFT OUTER JOIN staff_position as sp ON sp.id = p.position_id WHERE p.department_id = $department_id ORDER BY p.position_id");
