...
<body class="fix-header fix-sidebar card-no-border">
    ...
    <div id="main-wrapper">
                        ...
                        <div class="card">
                            <div class="card-header bg-light-info">
                                <div class="d-flex flex-wrap">
                                    <div>
                                        <h3 class="card-title">Add New Standard Leave Approval Sequence Form for
                                            Position <p class="font-weight-bold text-primary">Department: [<span
                                                    class="font-weight-bold text-primary"><?php echo $staff_department; ?></span>]<br>Position:
                                                [<span class="addNewPosition"></span>]</p>
                                        </h3>
                            ...
                            <div class="card-body">
                                <?php
                                                if(isset($_POST['submitApprovalSequence'])){
                                                    ...
                                                    $upd->executeSQL("UPDATE approvalsequence_standardleave_5 SET active = 0 WHERE sequence_no = $sequenceNo AND position_id = $position_id AND department_id = $department_id");
                                                    if($save->insert("approvalsequence_standardleave_5",$fields)){
                                                        $fieldsHistory = [
                                                            'position_id'=>$position_id,
                                ...
                                <?php
                                                ...
                                                if(isset($_POST['updateApprovalSequence'])) {
                                                    ...
                                                    if($save->update("approvalsequence_standardleave_5",$fields,$id)) {
                                                        ...
                                                        if($save->insert("approvalsequence_standard_history",$fieldsHistory)) {
                                                            $rows = $helper->readData("SELECT * FROM approvalsequence_standardleave_5 WHERE position_id = $position_id AND active = 1 ORDER BY sequence_no");
                                                            if($helper->totalCount != 0) {
                                                                $i = 1;
                                                                foreach($rows as $row){
                                                                    $id = $row['id'];
                                                                    $seqUpdater->executeSQL("UPDATE approvalsequence_standardleave_5 SET sequence_no = $i WHERE id = $id");
                                                                    $i++;
                                                                }
                                                            }
                                                            ?>
                                ...
                                <form class="form-horizontal p-t-20 p-l-0 p-" action="" method="POST" novalidate
                                    ...
                                    <div class="form-group row">
                                        <label class="col-lg-3 control-label"><span class="text-danger">*</span>College
                                            Position</label>
                                        <div class="col-lg-9">
                                            <div class="controls">
                                                <div class="input-group">
                                                    ...
                                                    <input type="hidden" name="department_id"
                                                        value="<?php echo $did; ?>" />
                                                    <select name="position_id" class="form-control select2 position_id"
                                                        required
                                    ...
                                    <div class="form-group row">
                                        <label class="col-lg-3 control-label"><span
                                                class="text-danger">*</span>Approver</label>
                                        <div class="col-lg-9">
                                            <div class="controls">
                                                <div class="input-group">
                                                    <input type="hidden" name="id" class="id" />
                                                    ...
                                                    <input type="hidden" name="department_id"
                                                        value="<?php echo $did; ?>" />
                                                    <select name="approver_id" class="form-control select2 approver_id"
                                                        required
                                                        data-validation-required-message="Please select college position">
                                        ...
                                        <div class="offset-sm-3 col-lg-9">
                                            <button type="submit" name="submitApprovalSequence"
                                                class="btn btn-info waves-effect waves-light submitApprovalSequence"><i
                                                    class="fa fa-paper-plane"></i> Submit Add New</button>
                                ...
                                <div class="col-lg-8 col-sm-18"><!---start for list div-->
                                    <div class="card">
                                        <div class="card-header bg-light-info">
                                            <div class="d-flex flex-wrap">
                                                <div>
                                                    <h4 class="card-title">Department: [<span class="font-weight-bold text-primary"><?php echo $staff_department; ?></span>]
                    </h4>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table id="dynamicTable" class="display table-hover table-striped table-bordered" cellspacing="0"
                    width="100%">
                    <thead>
                        <tr>
                            <th>Sequence</th>
    ...
    */ ?>
    ...
    $('.approverTitleClick').click(function() {
        ...
        $.ajax({
            url: 'ajaxpages/leaves/settings/edit_approver_standardleave_5.php',
            type: 'POST',
            dataType: 'json',
            data: data,
            success: function(e) {
