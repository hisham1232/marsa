                        ...
                        <div class="card"><!-- card-outline-success-->
                            <div class="card-header">
                                <div class="row ribbon-vwrapper">
                                            ...
                                            <div class="sl-item">
                                                ...
                                                <div class="sl-right">
                                                    <div><a href="#" class="link">Mylyn Nostarez</a> <span class="sl-date">[Staff ID : 408022]</span>
                                                        <div class="like-comm">
                                                            <a href="javascript:void(0)" class="link m-r-10">Computer Technician</a> 
                                                            <a href="javascript:void(0)" class="link m-r-10">Educational Services Section</a> 
                                                            <a href="javascript:void(0)" class="link m-r-10">Educational Technologies Centres</a> 
                                                        </div>
                                                    </div>
                                                    <p>
                                                        <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                                                            <div class="btn-group mr-2" role="group" aria-label="First group">
                                                                ...
                                                                <button type="button" class="btn btn-info">Employment History</button>
                                                                <button type="button" class="btn btn-secondary">Legal Documents</button>
                                                                <button type="button" class="btn btn-secondary">Qualification</button>
                                                                <button type="button" class="btn btn-secondary">Work Experience</button>
                                                                <button type="button" class="btn btn-secondary">Researches</button>
                                                                <button type="button" class="btn btn-secondary">Contacts</button>
                                                                <button type="button" class="btn btn-secondary">Family Information</button>
                                    ...
                                    </div><!--end col for hearder details-->
                                </div><!--end row-->
                            </div><!--end card header-->
