                                                            ...
                                                            <div class="form-horizontal p-t-20" action="" method="POST" novalidate enctype="multipart/form-data">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                        <div class="controls">
                                                                            <div class="input-group">
                                                                                <textarea class="form-control notes" rows="2" required data-validation-required-message="Reasons for Add Balance is required" minlength="1"></textarea>
                                                                                    <div class="input-group-prepend">
                                                                            ...
                                                                            if($fetch->totalCount != 0) {
                                                                                ...
                                                                                if($ax == 1){
                                                                                    ...
                                                                                    foreach($result as $row) {
                                                                                        array_push($to,$staff->getContactInfo(2,$row['staff_id'],'data'));
                                                                                    }
