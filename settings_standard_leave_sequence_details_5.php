                            ...
                            <div class="card-body">
                                <?php
                                                if(isset($_POST['submitApprovalSequence'])){
                                                    ...
                                                    //$last = $info->singleReadFullQry("SELECT TOP 1 sequence_no FROM approvalsequence_standardleave_5 WHERE department_id = $department_id AND position_id = $position_id ORDER BY sequence_no DESC");
                                ...
                                <form class="form-horizontal p-t-20 p-l-0 p-" action="" method="POST" novalidate
                                    ...
                                    <div class="form-group row">
                                        <label class="col-lg-3 control-label"><span class="text-danger">*</span>Is
                                            Final
                                            Approver</label>
                                        <div class="col-lg-9">
                                            <div class="controls">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div>
                                    ...
                                    <button class="btn btn-sm btn-primary viewHistory"><i class="fa fa-search"></i>
                                        View
