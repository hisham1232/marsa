                            ...
                            <div class="row">
                                <div class="col-lg-12 col-xs-18">
                                    <div class="card card-body">
                                        <h4 class="box-title m-b-0"><a class="btn btn-danger" href="internal_balance_add_direct.php"><i class="fa fa-plus"></i> I want to add a direct leave.</a></h4>
                                    </div>
                                </div>
                            </div>
                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <div class="d-flex flex-wrap">
                                                                <div>
                                                                    <h3 class="card-title">1. Add Internal Balance Form</h3>
                                                ...
                                                <div class="col-lg-8 col-xs-18">
                                                    <div class="card">                         
                                                        <div class="card-body">
                                                                        ...
                                                                        hell:
                                                                            ...
                                                                            if($fetch->totalCount != 0) {
                                                                                ...
                                                                                if($write->executeSQL("INSERT INTO internalleavebalancedetails (internalleavebalance_id, leavetype_id, staffId, startDate, endDate, total, status, notes, createdBy) SELECT internalleavebalance_id, 0, staffId, startDate, endDate, total, status, notes, createdBy FROM internalleavebalancedetails_draft")){
																					...
																					$write->executeSQL("DELETE FROM internalleavebalancedetails_draft");
                                                            ...
                                                            <div class="d-flex flex-wrap">                    
                                                                <div>
                                                                    <h3 class="card-title">2. Add Internal Balance to Staff</h3>
