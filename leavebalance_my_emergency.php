                                            ...
                                            <div class="table-responsive">
                                                <table id="intLeaveBalanceHistory" class="display table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                            $i = 0; 
                                                            $rows = $data->readData("SELECT i.* FROM emergencyleavebalancedetails as i WHERE i.staffId = '$staffId' ORDER BY i.id");
                                                            $runningBalance = 0;
                                                            foreach ($rows as $row) {
                                                                $staffId = $row['staffId'];
                                                                if ($row['addType'] == 1) 
                                                        ...
                                                        ?>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        ?>
                                                                                <a href="standardleave_my_details.php?id=<?php echo $row['emergencyleavebalance_id']; ?>&uid=<?php echo $staffId; ?>"><?php echo $row['emergencyleavebalance_id']; ?></a>
                                                                        <?php
                                                                            } else {
