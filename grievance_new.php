                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <div class="d-flex flex-wrap">
                                                                <div class="alert alert-info">UTAS-Nizwa aims to provide a healthy working environment to its staff by addressing their grievances arising during the course of their employment. It is committed to ensure a fair, consistent, effective and impartial resolution of grievances so as to achieve the college’s mission & vision and maintain its core values.</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>            
                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <div class="d-flex flex-wrap">
                                                                ...
                                                                if(isset($_POST['submit'])) {
                                                                    ...
                                                                    if($complainantSectionId == $responderSectionId) {
                                                                        $checkApprover = new DbaseManipulation;
                                                                        $row = $checkApprover->singleReadFullQry("SELECT * FROM grievance_workflow WHERE position_id = $myPositionId AND sequence_no = 1 AND is_final = 0 AND category_id = 1");
                                                                        if($checkApprover->totalCount != 0) {
                                                                            $responder_position_id = $helper->employmentIDs($responder,'position_id');
                                                                            if($responder_position_id == $row['approver_id']) {
                                                                                //echo "Against HOS, Category 2!";
                                                                                $category_id = 2;
                                                                            } else {
                                                                        ...
                                                                        if($complainantDepartmentId == $responderDepartmentId) {
                                                                            $checkIfHOD = new DbaseManipulation;
                                                                            $row = $checkIfHOD->singleReadFullQry("SELECT * FROM department WHERE managerId = $responder");
                                                                            if($checkIfHOD->totalCount != 0) {
                                                                                //echo "Against HOD, Category 3!...";
                                                                                $category_id = 3;
                                                                            } else {
                                                            ...
                                                            <form class="form-horizontal" action="" method="POST" novalidate enctype="multipart/form-data">
                                                                ...
                                                                <div class="form-group row m-b-5 m-t-0" style="display: none">
                                                                    <label  class="col-sm-3 control-label">Complaint Type</label>
                                                                    <div class="col-sm-9">
                                                                        <div class="controls">
                                                                            <div class="input-group">
                                                                                <select class="form-control complaint_type" name="complaint_type" required data-validation-required-message="Please select Nature of the Complaint">
                                                                            ...
                                                                            <br>
                                                                            <div class="alert alert-primary alert-dismissible fade show academicCCType" role="alert" style="display: none">
                                                                                <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                                                <strong><i class="fa fa-info-circle"></i> Academic Complaint</strong>
                                                                                <ol>
                                                                            ...
                                                                            <div class="alert alert-warning alert-dismissible fade show nonacademicCCType" role="alert" style="display: none">
                                                                                <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                                                <strong><i class="fa fa-info-circle"></i> Non Academic Complaint</strong>
                                                                                <ol>
                                                                                    <li>The staff has to have credit</li>
                                                                                    <li>The staff should apply before leaving</li>
                                                                                    <li>It should be approved by the direct head</li>
                    ...
                    $(document).ready(function(e) {
                        $(".complaint_type").change(function() {
                            ...
                            if(complaint_type_id == 1) {
                                $('.academicCCType').show();
                                $('.nonacademicCCType').hide();
                                
                            } else if (complaint_type_id == 2) {
                                $('.academicCCType').hide();
                                $('.nonacademicCCType').show();
