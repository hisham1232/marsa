                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <?php
                                                                            $rowTime = $getTimeIn->singleReadFullQry("SELECT TOP 1 inTime FROM fpuserlog WHERE userid = '$staffAydi' AND recordDate = '$ngayonDate' ORDER BY recordDate DESC");
                                                                    ...
                                                                    <td>
                                                                        <?php
                                                                            $rowTimeOut = $getTimeOut->singleReadFullQry("SELECT TOP 1 outTime FROM fpuserlog WHERE userid = '$staffAydi' AND recordDate = '$ngayonDate' ORDER BY recordDate DESC");
