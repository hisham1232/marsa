                                                                        ...
                                                                        <div>
                                                                            <div>
                                                                                <?php
                                                                                    ...
                                                                                    LEFT OUTER JOIN salarygrade as slr ON slr.id = e.salarygrade_id
                                                                                    LEFT OUTER JOIN position_category as pc ON pc.id = e.position_category_id
                                                                                    WHERE e.id = $eid AND e.isCurrent = 1
                                                                                    ");
                                                                                ?>
                                                                        ...
                                                                        ?>                        
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            <?php
                                                                                                if($row['isCurrent'] == 1)
                                                                                                    echo '<a href="staff_employment.php?id='.$id.'&edit='.md5("yes").'&eid='.$aydee.'" title="Click to edit this information" class="btn btn btn-outline-primary btn-sm" ><i class="fas fa-edit fa-2x"></i></a>';
                                                                                            ?>
                                                                                        </td>
                                                                                    </tr>
                                                                        <?php
