                                                        ...
                                                        <div class="controls">
                                                            <div class="input-group">
                                                                ...
                                                                <select name="staffIdTo" class="form-control staffIdTo" required data-validation-required-message="Please select Staff">
                                                                    ...
                                                                    <?php
                                                                        $rows = $helper->readData("SELECT s.id, s.staffId, concat(s.firstName,' ',s.secondName,' ',s.thirdName,' ',s.lastName) as staffName FROM staff as s LEFT OUTER JOIN employmentdetail as e ON s.staffId = e.staff_id WHERE e.status_id = 1 AND e.isCurrent = 1 AND e.department_id = $logged_in_department_id ORDER BY staffName");
                                                                        foreach ($rows as $row) {
                                                                            ?>
