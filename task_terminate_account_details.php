            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col-md-5 col-sm-12 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Terminate Staff Account Details</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item">Account Task</li>
                            <li class="breadcrumb-item">Terminate Account</li>
                        </ol>
                    </div>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="d-flex flex-wrap">
                                                    <div>
                                                        <h3 class="card-title">Terminate Account Form</h3>
                                                        <h6 class="card-subtitle font-italic">Staff was requested to Terminate related e-services and e-mail account</h6>
                                                    </div>
                                                </div>
                                                <form class="form-horizontal p-t-20" action="" method="POST" novalidate enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <div class="controls">
                                                                <div class="input-group">
                                                                     <input type="text" name="numberofdays" class="form-control" readonly value="Resigned"> 
                                                                    <div class="input-group-prepend">
                                                                        <span class="input-group-text" id="basic-addon2">
                    ...
                    <div class="col-lg-6"><!---start short leave approval form div-->
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="d-flex flex-wrap">
                                                    <div>
                                                        <h3 class="card-title">Terminate Staff Account Tasks</h3>
                                                ...
                                                <div class="ribbon-vwrapper card">
                                                    ...
                                                    <h3 class="ribbon-content">Terminate Email Account</h3>
                                                ...
                                                <div class="ribbon-vwrapper card">
                                                    ...
                                                    <h3 class="ribbon-content">Terminate Active Directory Account</h3>
                                                    <p class="ribbon-content"><span class="text-muted">Status : <span class="text-primary">Approved</span>
                                                    <span class="text-muted pull-right">September 22, 2018</span></span></p>
                                                    <p class="ribbon-content"><i>A sample text comment during approval.</i></p>
                                                </div>
                                                ...
                                                <div class="ribbon-vwrapper card">
                                                    ...
                                                    <h3 class="ribbon-content">Terminate System User Type</h3>
                                                    <p class="ribbon-content"><span class="text-muted">Status : <span class="text-primary">Approved</span>
                                                    <span class="text-muted pull-right">September 22, 2018</span></span></p>
                                                    <p class="ribbon-content"><i>A sample text comment during approval.</i></p>
                                                </div>
