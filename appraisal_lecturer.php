                                        ...
                                        <div class="d-flex no-block align-items-center">
                                            ...
                                            <div class="ml-auto">
                                                <ul class="list-inline text-right">
                                                    ...
                                                    $rec = $checkSubmitted->singleReadFullQry("SELECT TOP 1 * FROM appraisal_lecturer WHERE staff_id = '$staffId' AND appraisal_year = '$currentYear' ORDER BY id DESC");
                                                    if ($checkSubmitted->totalCount != 0) {
                                                        ...
                                                        $requestNo = $request->requestNo("LAP-", "appraisal_lecturer");
                                                        $show = 'display: none';
                                                    }
                                                    ?>
                                                    <li>ID/Status <span class="font-weight-bold text-info"><?php echo $requestNo; ?> - <?php echo $rec['status']; ?></span></li>
                                                    <li>
                                                        <!-- <a style="<?php echo $show; ?>" href="appraisal_lecturer_view.php?id=<?php echo $rec['id']; ?>&y=<?php echo $_GET['y']; ?>" target="_blank" class="btn btn-sm btn-warning waves-effect waves-light" title="Click to Show the Appraisal Result to Staff"><i class="fas fa-search"></i> View Result</a> -->
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane p-20" id="SelfAppraisal" role="tabpanel">
                                                ...
                                                if (isset($_POST['submitLecturer'])) {
                                                    ...
                                                    $checkRequest->singleReadFullQry("SELECT TOP 1 id, requestNo FROM appraisal_lecturer WHERE requestNo = '$requestIdNumber' ORDER BY id DESC");
                                                    if ($checkRequest->totalCount != 0) {
                                                        $req = new DbaseManipulation;
                                                        $newReqNo = $req->requestNo("LAP-", "appraisal_lecturer");
                                                    } else {
                                                    ...
                                                    // print_r($fields);
                                                    // echo"</pre>";
                                                    $saveLect = new DBaseManipulation;
                                                    if ($saveLect->insert("appraisal_lecturer", $fields)) {
                                                        ...
                                                        if ($emailParticipants->smtpMailer($to, $from_name, $from, $subject, $message)) {
                                                            ...
                                                            $emailFields = [
                                                                'requestNo' => $newReqNo,
                                                                'moduleName' => 'Lecturer - Staff Appraisal Submitted',
                                                                'sentStatus' => 'Sent',
                                                ...
                                                ?>
                                                    <form id="lectForm" method="POST" action="" novalidate>
                                                        <div class="card">
                                                            <div class="card-header bg-light-success p-b-0 p-t-5">
                                                                <h4 class="card-title">Job Definition</h4>
                                                            </div>
                                                        ...
                                                        <div class="card">
                                                            ...
                                                            <div class="card-body">
                                                                <div class="form-group">
                                                                    <h5>In what specific areas would you like to improve your job performance? <span class="text-danger">*</span></h5>
                                                                    <div class="controls">
                                                                ...
                                                                <div class="form-group">
                                                                    <h5>What kind of support and/or guidance would you like to see from your supervisor? <span class="text-danger">*</span></h5>
                                                                    <div class="controls">
                                                        ...
                                                        <div class="text-xs-right">
                                                            ...
                                                            <button type="submit" name="submitLecturer" class="btn btn-info waves-effect waves-light"><i class="fa fa-paper-plane"></i> Submit Appraisal</button>
                                                            ...
                                                            <div class="card-body">
                                                                <div class="table-responsiveXXX">
                                                                    <div class="row border-bottom ">
                                                                        ...
                                                                        $rows = $sdn->singleReadFullQry("SELECT * FROM [appraisal_lecturer_teaching_attribute] WHERE appraisal_lecturer_id =  $appraisal_lecturer_id"); //1 is fixed for technicians
                                                                        ?>
                                                                        ...
                                                                        <div class="col-lg-4">
                                                                            <label>
                                                                                <label>
                                                                                    <h3><span id="grandTotalX"><?php echo $rows['grand_total'] ?></span> - <span id="grandRemarksX"><?php echo $rows['grand_remarks']; ?></span></h3>
                                                                                </label>
                                                                            </label>
                                                                        </div>
                                                                    ...
                                                                    <div class="row border-bottom m-t-5">
                                                                        ...
                                                                        $row = $hosObs->singleReadFullQry("SELECT TOP 1 * FROM appraisal_hos_observation WHERE appraisal_type_description_id = 2 AND appraisal_type_id =  $appraisal_technician_id"); //1 is fixed for technicians
