<?php
    ...
    if($startDate == "" || $endDate == "") {
        ...
        if($filterOut->totalCount < 1) {
            $filterRows = $filter->singleReadFullQry("SELECT staffId, startDate, endDate FROM internalleavebalancedetails_draft WHERE staffId = '$staffId' AND startDate <= '$startDate' AND endDate >= '$endDate'");
