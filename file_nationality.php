                                        ...
                                        <div class="card-body">
                                            <div class="d-flex flex-wrap">
                                                <div>
                                                    ...
                                                    <h6 class="card-subtitle">اضافة جنسية</h6> 
                                                </div>
                                            </div>
                                            <?php 
                                            ...
                                            <form class="form-horizontal p-t-20" action="" method="POST" novalidate enctype="multipart/form-data">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="controls">
                                                            <div class="input-group">
                                                                <input type="text" name="name" class="form-control" required data-validation-required-message="Please type the nationality name" /> 
                                                            </div><!--end input-group-->
                                                        </div><!--end controls-->
                                                    </div><!--end col-sm-9-->
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="controls">
                                                            <div class="input-group">
                                                                <input type="text" name="country" class="form-control" required data-validation-required-message="Please type the country's name" />
                                                            </div><!--end input-group-->
                                                        </div><!--end controls-->
                                                    </div><!--end col-sm-9-->
                                                </div><!--end form-group row --->
