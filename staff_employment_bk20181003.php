                ...
                <div class="row page-titles">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-10 col-xlg-10 col-md-8">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Staff Employment History (in NCT)</h4>
                                ...
                                <!-------------------------------->    
                                    <div class="col-md-7">
                                        <div class="card border-success">
                                          <div class="card-header" style="border-bottom-style: solid; border-bottom: double; border-color: #28a745">Staff Employment History (in NCT)</div>
                                          <div class="card-body">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>1</td>
                                                <td><span class="text-primary font-weight-bold">Masters</span></td>
