                            ...
                            <div class="row page-titles">
                                <div class="col-md-5 col-sm-12 align-self-center">
                                    ...
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item">Direct Internal Balance</li>
                                    </ol>
                                </div>
                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <div class="d-flex flex-wrap">
                                                                <div>
                                                                    <h3 class="card-title">1. Add Direct Internal Balance Form</h3>
                                                                    <h6 class="card-subtitle text-info"><em><i class="fas fa-info-circle"></i> Select Department, Staff, Add Working Days, Click Add Leave</em></h6>
                                                                </div>
                                                            </div>
                                                            <div class="form-horizontal p-t-20" action="" method="POST" novalidate enctype="multipart/form-data">
                                                                <div class="form-group row">
                                                                    <label  class="col-sm-3 control-label"><span class="text-danger">*</span>Dept.</label>                  
                                                                    <div class="col-sm-9">
                                                                        <div class="controls">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                        <div class="controls">
                                                                            <div class="input-group">
                                                                                <select class="form-control staffDropDown" name="staff_id" required data-validation-required-message="Please select staff">
                                                                                    <?php
                                                                                        if(isset($_GET['uid'])) {
                                                                                            $uid = $_GET['uid'];
                                                                ...
                                                                <div class="form-group row">
                                                                    <label  class="col-sm-3 control-label"><span class="text-danger">*</span>Days</label>                  
                                                                    <div class="col-sm-9">
                                                                        <div class="controls">
                                                                            <div class="input-group">
                                                                                ...
                                                                                <input type="number" name="noOfDays" value="" class="form-control noOfDays" /> 
                                                                                <div class="input-group-prepend">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                        <div class="controls">
                                                                            <div class="input-group">
                                                                                <textarea class="form-control notes" rows="2" required data-validation-required-message="Reasons for Add Balance is required"></textarea>
                                                                                    <div class="input-group-prepend">
                                                                ...
                                                                <div class="form-group row m-b-0">
                                                                    <div class="offset-sm-3 col-sm-9">
                                                                        <button class="btn btn-primary waves-effect waves-light draftAddInternalLeave2">Add Staff To List <i class="fa fa-arrow-right"></i></button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-lg-8 col-xs-18">
                                                    <div class="card">                         
                                                        <div class="card-body">
                                                                ...
                                                                if(isset($_POST['finalizedSubmit'])){
                                                                    ...
                                                                    if (!empty($_FILES['fileToUpload']['name'])) {
                                                                        ...
                                                                        hell:
                                                                            ...
                                                                            $distinct = $fetch->readData("SELECT DISTINCT internalleavebalance_id, created, notes, createdBy FROM internalleavebalancedetails_draft");
                                                            ...
                                                            <div class="d-flex flex-wrap">                    
                                                                <div>
                                                                    <h3 class="card-title">2. Add Direct Internal Balance to Staff</h3>
                                                                    <h6 class="card-subtitle text-info"><em><i class="fas fa-info-circle"></i> Observe the staff on the list and click Finalized Button once completed.</em></h6>
                                                                </div>
                                                                <div class="ml-auto">
