            ...
            <body class="fix-header fix-sidebar card-no-border">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <?php
                                                                if(isset($_POST['submitApplication'])) {
																	...
																	// to check if the staff has already aleave within the selected date range
																	$checkDateRange = new DbaseManipulation;
                                                            $checkDateRange->checkDateRange("SELECT id FROM standardleave where staff_id='" . $staffId . "' and currentStatus IN ('Approved','Pending') and
                                                                    (
                                                                    '" . $_POST['startDate'] . "' between startDate and endDate or '" . $_POST['endDate'] . "' between startDate and endDate
                                                                    or startDate between '" . $_POST['startDate'] . "' and  '" . $_POST['endDate'] . "' or endDate between '" . $_POST['startDate'] . "' and  '" . $_POST['endDate'] . "'
                                                                    ) ");

                                                            if ($checkDateRange->totalCount == 1) {
                                                                ?>
                                                                <br />
                                                                <div class="alert alert-danger">
                                                                    <h4 class="alert-heading"><i class="fa fa-exclamation-triangle"></i> Date Range Mismach!</h4>
                                                                    <p>You have already a leave among the selected date range (<?= $_POST['startDate'] ?>-<?= $_POST['endDate']  ?>)</p>
                                                                 </div>
                                                                <?php
                                                                    ...
                                                                    if($checkRequest->totalCount != 0) {
                                                                        ...
                                                                        $newReqNo = $req->requestNo("STL-","standardleave");    
                                                                    } else {
                                                                    ...
                                                                    if($submit->insert("standardleave",$fields)){
                                                                        ...
                                                                        if($leavetype_id == 2) { //Emergency Leave MUST be inserted in emergencyleavebalancedetails table
                                                                            $fields2 = [
                                                                                'emergencyleavebalance_id'=>$newReqNo,
                                                                                'staffId'=>$staffId,
                                                                                'startDate'=>$_POST['startDate'],
                                                                                'endDate'=>$_POST['endDate'],
                                                                                'total'=>$negativeTotal,
                                                                            ...
                                                                            $fields2 = [
                                                                                'internalleavebalance_id'=>$newReqNo,
                                                                                'leavetype_id'=>$_POST['leaveTypeId'],
                                                                                'staffId'=>$staffId,
                                                                                'startDate'=>$_POST['startDate'],
                                                                                'endDate'=>$_POST['endDate'],
                ...
                <div class="modal fade" id="myModalError" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-body" style="text-align: center">
                                <h3 class="modal-title text-danger" id="myModalLabel"><i class='fa fa-exclamation-triangle'></i> Error</h3>
                                <h5>Unable to complete your leave request. A technical error has been occured. <br/>Please click on OK button and start filing again.</h5>
                                <a href="" class="btn btn-success"><i class='fa fa-check'></i> OK</a>
                            </div>
                        </div>
                    </div>
                </div>  
