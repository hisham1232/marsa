                                            ...
                                            <div class="card-body">
                                                <div class="btn-toolbar btn-block" role="toolbar" aria-label="Toolbar with button groups">
                                                    <div class="btn-group" role="group" aria-label="First group">
                                                        ...
                                                        <a class="btn btn-secondary" href="staff_employment_archive.php?id=<?php echo $id; ?>" title="Click to view Employment History" role="button"><span class="hidden-sm-up"><i class="ti-briefcase"></i></span> <span class="hidden-xs-down"><i class="ti-angle-double-down"></i> Employment History</a>
                                                            ...
                                                            <div class="card-header">
                                                                ...
                                                                ?>
                                                                            <div class="alert alert-success" role="alert">
                                                                                ...
                                                                                <p>Staff basic information has been edited and updated!</p>
                                                                            </div>
                                                                <?php
                                                                        }        
                                                                    }
