<?php    
    ...
    if(!$helper->isUserLogged()) {
        ...
        if($allowed){
            if(isset($_GET['id'])) {
                $id = $_GET['id'];
                $section = new DbaseManipulation;
                $result = $section->singleRead("section",$id);
                $field = $section->fieldNameValue("section",$id,'id');
            }                                 
?>  
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex flex-wrap">
                                                <div>
                                                    ...
                                                    <h6 class="card-subtitle">تحرير الشعبة</h6> 
                                                </div>
                                            </div>
                                            <?php 
                                            ...
                                            <form class="form-horizontal p-t-20" action="" method="POST" novalidate enctype="multipart/form-data">
                                                <div class="form-group row">
                                                    <label for="exampleInputuname3" class="col-sm-3 control-label">Section Id<br>رقم الشعبة</label>
                                                    <div class="col-sm-9">
                                                        <div class="controls">
                                                            <div class="input-group">
                                                                <input type="hidden" name="id" value="<?php echo $result['id']; ?>">
                                                                <input type="text" name="uid" value="<?php echo $field; ?>" class="form-control" required data-validation-required-message="Please type the section Id" readonly /> 
                                                            </div><!--end input-group-->
                                                        </div><!--end controls-->
                                                    </div><!--end col-sm-9-->
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="controls">
                                                            <div class="input-group">
                                                                <input type="text" name="name" value="<?php echo $result['name']; ?>" class="form-control" required data-validation-required-message="Please type the section name" /> 
                                                            </div><!--end input-group-->
                                                        </div><!--end controls-->
                                                    </div><!--end col-sm-9-->
                                                </div><!--end form-group row --->
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="controls">
                                                            <div class="input-group">
                                                                <input type="text" name="shortName" value="<?php echo $result['shortName']; ?>" class="form-control" required data-validation-required-message="Please type the section's short name" />
                                                            </div><!--end input-group-->
                                                        </div><!--end controls-->
                                                    </div><!--end col-sm-9-->
                                                </div><!--end form-group row --->
                                                            ...
                                                            <div class="input-group">
                                                                <select name="department_id" class="form-control select2" required data-validation-required-message="Please select a department from the list">
                                                                    ...
                                                                    <?php 
                                                                        ...
                                                                        foreach ($rows as $row) {
                                                                            if($result['department_id'] == $row['id']) {
                                                                    ?>
                                                ...
                                                <div class="form-group row m-b-0">
                                                    <div class="offset-sm-3 col-sm-9">
                                                        ...
                                                        <a href="file_section.php" class="btn btn-success waves-effect waves-light"><i class="fa fa-file"></i> Add New</a>
                                                        <!-- <a href="" class="btn btn-danger waves-effect waves-light delete-confirm" delete-id="<?php //echo $result['id']; ?>" deleting="section"><i class="fa fa-times"></i> Delete</a> -->
                                                    </div>
                                                </div>
                                            </form><!--end form-->
                                        </div><!--end card body-->
