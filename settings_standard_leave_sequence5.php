                                        ...
                                        <div class="card">
                                            <div class="card-header" id="headingOne">
                                                <div class="d-flex no-block align-items-center">
                                                    <h4 class="card-title">
                                                        <button class="btn collapsed btn-link text-left" type="button"
                                                            data-toggle="collapse"
                                                            data-target="#departmentId<?php echo $row['department_id']; ?>"
                                                            aria-expanded="true" aria-controls="collapseTwo">
                                                            <i class="fa as fa-key main"></i><i
                                                                class="fa fa-angle-double-right mr-3"></i><?php echo $row['departmentName']." (".$row['shortName'].")"; ?>
                                                        </button>
                                                    </h4>
                                                </div>
                                                <!--end d-flex -->
                                            ...
                                            <!--end card-header-->
                                            <div id="departmentId<?php echo $row['department_id']; ?>"
                                                class="collapse fade" aria-labelledby="headingOne"
                                                data-parent="#accordionShortLeaveSequence">
                                                <a href="settings_standard_leave_sequence_details_add_5.php?did=<?php echo $row['department_id']; ?>"
                                                    class="btn  btn-primary waves-effect waves-light" role="button"
                                                    title="Click to view/edit Approval Sequence"><span
                                                        class="text-white"><i class="fa fa-paper-plane"></i> Add
                                                        New</span></a>
                                                <br>
                                                <div class="card-body">
                                                        ...
                                                        <table data-toggle="table" data-mobile-responsive="true"
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <?php    
                                                                                                                ...
                                                                                                                ?>
                                                                <td><a href="settings_standard_leave_sequence_details_5.php?pid=<?php echo $posi_id; ?>&did=<?php echo $row['department_id']; ?>"
                                                                        class="btn btn-sm btn-info waves-effect waves-light"
                                                                        role="button"
                                                                        title="Click to view/edit Approval Sequence"><span
                                                                            class="text-white"><i
                                                                                class="fa fa-paper-plane"></i> Update
                                                                            List</span></a></td>
                                                                <?php                                                                                                            
                                                                                                        echo "</tr>";
                                                                                                }        
                                                ...
                                                <!--end card body for table-->
                                            </div>
                                            <!--end collapseOne id-->
                                        </div>
                                        <!--end card for one entry-->
                                        <?php
                                                            }
                                                        }
                                                    ?>
                                    </div>
                                    <!--end for accordion whole-->
                                </div>
                                <!--end for accordion style-1-->
                            </div>
                            <!--end card body for all-->
                        </div>
                    </div>
                    <!--end col-lg-12-->
                </div>
