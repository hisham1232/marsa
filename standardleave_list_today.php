                        ...
                        <div class="container-fluid">
                            <div class="row page-titles">
                                <div class="col-md-5 col-8 align-self-center">
                                    <h3 class="text-themecolor m-b-0 m-t-0">All Standard Leave List For Today</h3>
                                    <ol class="breadcrumb">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="card-title">All Staff Standard Leave List For Today</h4>
                                                ...
                                                <table id="dynamicTableAllSTL" class="display table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <?php 
                                                        ...
                                                        if(isset($_POST['searchByDate'])) {
                                                            ...
                                                            $sql = "SELECT s.id, s.staff_id, concat(sf.firstName,' ',sf.secondName,' ',sf.thirdName,' ',sf.lastName) as staffName, d.name as department, sec.name as section, sp.name as sponsor, s.requestNo, l.name as leave_type, s.dateFiled, s.startDate, s.endDate, s.total, s.modified, s.currentStatus FROM standardleave as s LEFT OUTER JOIN staff as sf ON sf.staffId = s.staff_id LEFT OUTER JOIN leavetype as l ON s.leavetype_id = l.id LEFT OUTER JOIN employmentdetail as e ON e.staff_id = s.staff_id LEFT OUTER JOIN department as d ON d.id = e.department_id LEFT OUTER JOIN section as sec ON sec.id = e.section_id LEFT OUTER JOIN sponsor as sp ON sp.id = e.sponsor_id WHERE e.isCurrent = 1 AND s.dateFiled >= '$nowDate' AND s.dateFiled <= '$endDate' ORDER BY s.id DESC";
                                                            $rows = $data->readData($sql);
                                                        }
