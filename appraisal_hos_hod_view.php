                                ...
                                <div class="col-lg-12 col-xs-18">
                                    <div class="card">
                                        <?php 
                                            ...
                                            $currentYear = date('Y');
                                            $id = $_GET['id'];
                                            $rec = $checkSubmitted->singleReadFullQry("SELECT TOP 1 * FROM appraisal_hos WHERE id = $id AND appraisal_year = '$currentYear' ORDER BY id DESC");
                                        ...
                                        <div class="card-body">
                                            <ul class="nav nav-tabs customtab2" role="tablist">
                                               <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#Qualification" role="tab"><span class="hidden-sm-up"><i class="ti-home"></i></span> <span class="hidden-xs-down">Qualification</span></a> </li>
                                                ...
                                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#Observation" role="tab"><span class="hidden-sm-up"><i class="ti-email"></i></span> <span class="hidden-xs-down">HOD/HOC Observation</span></a> </li>
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div class="tab-pane p-20" id="Attribute" role="tabpanel">
                                                    <div class="card">
                                                        <?php 
                                                            $appraisal_hos_id = $_GET['id'];
                                                            $genAtt = new DbaseManipulation;
                                                            $row = $genAtt->singleReadFullQry("SELECT * FROM appraisal_hos_general_attribute WHERE appraisal_hos_id = $appraisal_hos_id");
                                                        ...
                                                        <div class="card-body">
                                                            <?php 
                                                                if(isset($_POST['submitGeneralAttribute'])) {
                                                                    ...
                                                                    if($helper->insert("appraisal_hos_general_attribute",$fields)) {
                                                                        ?>
                                                                        <script>
                                                                ...
                                                                if($genAtt->totalCount != 0) {
                                                                    ...
                                                                    <form novalidate>
                                                                        <div class="demo-radio-button">
                                                                            ...
                                                                            <div class="row border-bottom m-t-5">
                                                                                <div class="col-lg-5 col-xs-18">Follows the dress code</div>
                                                                                <?php 
                                                                                    for($a=5; $a>=1; $a--) {
                                                                                        if($a >= 4) {
                                                                                            $col_class = 'col-lg-2';
                                                    ...
                                                    <div class="card">
                                                        <?php 
                                                            ...
                                                            $row = $teachAtt->singleReadFullQry("SELECT * FROM appraisal_hos_working_attribute WHERE appraisal_hos_id = $appraisal_hos_id");
                                                        ...
                                                        <div class="card-body">
                                                            <?php 
                                                                if(isset($_POST['submitWorkingAttribute'])) {
                                                                    ...
                                                                    //print_r($fields);
                                                                    if($helper->insert("appraisal_hos_working_attribute",$fields)) {
                                                                        ?>
                                                                        <script>
                                                                            $(document).ready(function() {
                                                                    ...
                                                                    if($myPositionId != 1) { 
                                                                        ...
                                                                        <form method="POST" action="" novalidate>
                                                                            <div class="demo-radio-button">
                                                                                ...
                                                                                <div class="row border-bottom m-t-5">
                                                                                    <div class="col-lg-5 col-xs-18">Always give attention to details</div>
                                                                                    <div class="col-lg-2 col-xs-18">
                                                ...
                                                <div class="tab-pane p-20" id="Development" role="tabpanel">
                                                    <div class="card">
                                                        <?php 
                                                            ...
                                                            $rows = $sdn->readData("SELECT * FROM appraisal_trainings WHERE appraisal_type_description_id = 4 AND appraisal_type_id = $appraisal_hos_id"); //4 is fixed for hos
                                                            if($sdn->totalCount != 0) {
                                                                $tobeVisible2 = '';
                                                            } else {
                                                                $tobeVisible2 = '[To be filled by the HOD/HOC]';
                                                            }
                                                        ?>
                                                        ...
                                                        <div class="card-body">
                                                            <?php 
                                                                if(isset($_POST['submitStaffDevelopment'])) {
                                                                    ...
                                                                    $fields = array();
                                                                    $fields = [
                                                                        'appraisal_type_description_id'=>4,
                                                ...
                                                <div class="tab-pane p-20" id="Observation" role="tabpanel">
                                                    <div class="card">
                                                        <?php 
                                                            ...
                                                            $row = $hosObs->singleReadFullQry("SELECT TOP 1 * FROM appraisal_hos_observation WHERE appraisal_type_description_id = 4 AND appraisal_type_id = $appraisal_hos_id"); //4 is fixed for HoS
                                                            if($hosObs->totalCount != 0) {
                                                                $tobeVisible3 = '';
                                                            } else {
                                                                $tobeVisible3 = '[To be filled by the HOD/HOC]';
                                                            }
                                                        ?>
                                                        ...
                                                        <div class="card-body">
                                                            <?php 
                                                                if(isset($_POST['submitHOSObservation'])) {
                                                                    ...
                                                                    //print_r($fields);
                                                                    if($helper->insert("appraisal_hos_observation",$fields)) { //Even though HoD/HoC is the one logged in here, save it in appraisal_hos_observation, just use the appraisal_type_description_id = 4 if you want to filter the observation of the HoD/HoC
                                                                        ...
                                                                        $sql = "UPDATE appraisal_hos SET status = 'Approved by the Direct Manager', current_approver = $approver_id, current_sequence = $sequence_no_next WHERE id = ".$_GET['id'];
                                                                        $helper->executeSQL($sql);
                                                                        $get = new DbaseManipulation;
                                                                        $rowREqNo = $get->singleReadFullQry("SELECT TOP 1 requestNo FROM appraisal_hos WHERE id = ".$_GET['id']);
                                                                        ...
                                                                        if($emailParticipants->smtpMailer($to,$from_name,$from,$subject,$message)){
                                                                            ...
                                                                            $emailFields = [
                                                                                'requestNo'=>$newReqNo,
                                                                                'moduleName'=>'HOS - Staff Appraisal Approved By Direct Manager (HOD)',
                                                                                'sentStatus'=>'Sent',
                                                                ...
                                                                if($hosObs->totalCount != 0) {
                                                                    ...
                                                                    <form class="form-horizontal">
                                                                        ...
                                                                        <div class="form-group row m-b-5 m-t-0">
                                                                            <label  class="col-sm-3 control-label">HOD/HOC Opinion</label>
                                                                            <div class="col-sm-9">
                                                                                <div class="controls">
                                                                                    <?php 
                                                                                        $rowsHoS = $helper->readData("SELECT * FROM appraisal_hos_hod_recommendation ORDER BY id");
                                                        ...
                                                        //if($x == 1) {
                                                            if(isset($_POST['deanApproval'])) {
                                                                ...
                                                                if($helper->insert("appraisal_dean_observation",$fields)) {
                                                                    ...
                                                                    $sql = "UPDATE appraisal_hos SET status = 'Completed' WHERE id = ".$_GET['id'];
                                                                    $helper->executeSQL($sql);                                                                    
                                                                    $contact_details = new DbaseManipulation;
                                                                    $gsm = $contact_details->getContactInfo(1,$staff_id,'data');
                                                                    $staff_email = $contact_details->getContactInfo(2,$staff_id,'data');
                                                            ...
                                                            <?php 
                                                                ...
                                                                $deanRow = $dean->singleReadFullQry("SELECT TOP 1 * FROM appraisal_dean_observation WHERE appraisal_type_description_id = 4 AND appraisal_id = $appraisal_hos_id"); //4 is fixed for hos
                                                                if($dean->totalCount != 0) {
                                                                    $tobeVisible5 = '';
                                                                } else {
                                                                    $tobeVisible5 = '[To be filled by the Asst. Dean/College Dean]';
                                                                }

                                                                $hoDObs = new DbaseManipulation;
                                                                $rowHoD = $hoDObs->singleReadFullQry("SELECT TOP 1 * FROM appraisal_hos_observation WHERE appraisal_type_description_id = 4 AND appraisal_type_id = $appraisal_hos_id"); //4 is fixed for hos
                                                            ?>
                                                            <div class="card">
                                                                ...
                                                                <div class="card-body">
                                                                        <?php 
                                                                            if($hoDObs->totalCount != 0) {
                                                                                ...
                                                                                <form class="form-horizontal">
                                                                                    <div class="form-group row m-b-5 m-t-0">
                                                                                        <label  class="col-sm-2 control-label">HOD/HOC Opinion</label>
                                                                                        <div class="col-sm-9">
                                                                                            <div class="controls">
                                                                                            <?php 
                                                                                                $rowsHoS = $helper->readData("SELECT * FROM appraisal_hos_hod_recommendation ORDER BY id");
                                                                ...
                                                                <div class="card-body">
                                                                    <?php 
                                                                        if($dean->totalCount != 0) {
                                                                            ...
                                                                            <form class="form-horizontal">
                                                                                <div class="form-group row m-b-5 m-t-0">
                                                                                    <label  class="col-sm-2 control-label">Are You Agree with the HOD/HOC?</label>
                                                                                    <div class="col-sm-9">
                                                                                        <div class="controls">
                                                                                            <?php
                                                                                                $agree = new DbaseManipulation;
                                                                                                $rowAgree = $agree->singleReadFullQry("SELECT * FROM appraisal_hod_observation WHERE appraisal_type_description_id = 4 AND appraisal_id = $appraisal_hos_id"); 
                                                                            ...
                                                                            <form class="form-horizontal" action="" method="POST" novalidate>
                                                                                ...
                                                                                <?php 
                                                                                    if($myPositionId <= 4) {
                                                                                        $approval = new DbaseManipulation;
                                                                                        $approval->singleReadFullQry("SELECT TOP 1 * FROM appraisal_hos WHERE id = $appraisal_hos_id AND current_approver = $myPositionId"); //1 is fixed for technicians
                                                                                        if($approval->totalCount != 0) {
                                                                                            ?>
                                                                                            <div class="form-group row m-b-0">
                                                                                                <div class="offset-sm-2 col-sm-10">
                                                                                                    <button type="submit" name="deanApproval" class="btn btn-info waves-effect waves-light"><i class="fa fa-paper-plane"></i> Submit Approvals</button>                                                            
                                                                                                </div>
                                                                                            </div>
                                                                                            <?php
                                                                                        } 
